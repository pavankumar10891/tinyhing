...
/**
* NoneComplanceController Controller
*
* Add your methods in the class below
*
*/
class NoneComplanceController extends BaseController {

	public $model				=	'ExportNoneComplace';
	public $sectionName			=	'Export Customer Non-Compliance Data';
	public $sectionNameSingular	=	'Export Customer Non-Compliance Data';
		...
		if(!empty($formData)){
			$validator 					=	Validator::make(
				...
				array(
					...
					"amount.numeric"		=>	trans("The numeric only."),
			...
			if ($validator->fails()){
				...
				$data 			= 	array('start_date' => $startDate ,'end_date' => $endDate, 'amount' => $request->amount); 
				return Excel::download(new ExportNoncompliance($data), 'non-compliance-data-information-'.time().'.xlsx');
			}
		}
	}//end function 
