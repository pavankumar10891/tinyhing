        ...
        <div class="heading py-lg-5 pb-3  text-center">
            ...
            <div class="row py-5">
              <?php $__currentLoopData = $pakages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <button class="coupon-sub-btn plan_id mt-3">Submit</button>
            </div>
        </div>
</div>
<?php endif; ?>   
...
<?php echo $__env->make('front.layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tinyhugs\resources\views/front/pages/pricing.blade.php ENDPATH**/ ?>