...
<div class="content  d-flex flex-column flex-column-fluid" id="kt_content">
			...
			<div class="d-flex align-items-center flex-wrap mr-1">
				...
				<div class="d-flex align-items-baseline flex-wrap mr-5">
					...
					<h5 class="text-dark font-weight-bold my-1 mr-5">
						<?php echo e(ucwords(str_replace("-"," ",$type))); ?> Management </h5>
					<!--end::Page Title-->
	...
	<div class="d-flex flex-column-fluid">
		<!--begin::Container-->
		<div class=" container ">
			<?php echo e(Form::open(['role' => 'form','url' => 'adminpnlx/lookups-manager/'.$type,'class' => 'kt-form kt-form--fit mb-0 mws-form',"method"=>"get"])); ?>
					...
					<div class="card card-custom card-stretch card-shadowless">
						<div class="card-header">
							...
							<div class="card-toolbar">
								...
								<a href='<?php echo e(route("$modelName.add",$type)); ?>'  class="btn btn-primary"> <?php echo e(trans("Add New ")); ?><?php echo e(ucwords(str_replace("-"," ",$type))); ?>  </a>
							</div>
						</div>
						<div class="card-body">
									...
									<div>
											<div class="row mb-6">
												<div class="col-lg-3 mb-lg-5 mb-6">
													<label>Title</label>
													<?php echo e(Form::text('code',((isset($searchVariable['code'])) ? $searchVariable['code'] : ''), ['class' => ' form-control','placeholder'=>'Title'])); ?>
											...
											<div class="row mt-8">
												<div class="col-lg-12">
													...
													<a href='<?php echo e(URL::to('adminpnlx/lookups-manager/'.$type)); ?>'  class="btn btn-secondary btn-secondary--icon">
														<span>
												...
												<?php $__currentLoopData = $results; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $result): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
													<tr>
														...
														<td class="text-right pr-2">
															<?php if($result->is_active == 1): ?>
																<a  title="Click To Deactivate" href='<?php echo e(URL::to('adminpnlx/lookups-manager/update-lookups/'.$result->id.'/'.'0'.'/'.$type)); ?>' class="btn btn-icon btn-light btn-hover-danger btn-sm status_any_item" data-toggle="tooltip" data-placement="top" data-container="body" data-boundary="window" data-original-title="Click To Deactivate">
															...
															<?php else: ?>
																<a title="Click To Activate" href='<?php echo e(URL::to('adminpnlx/lookups-manager/update-lookups/'.$result->id.'/'.'1'.'/'.$type)); ?>' class="btn btn-icon btn-light btn-hover-success btn-sm status_any_item" data-toggle="tooltip" data-placement="top" data-container="body" data-boundary="window" data-original-title="Click To Activate">
															...
															<a href='<?php echo e(URL::to('adminpnlx/lookups-manager/edit-lookups/'.$result->id.'/'.$type)); ?>'
															...
															<a href='<?php echo e(URL::to('adminpnlx/lookups-manager/delete-lookups/'.$result->id.'/'.$type)); ?>'
...
<?php echo $__env->make('admin.layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp\htdocs\tinyhugs\resources\views/admin/Lookups/index.blade.php ENDPATH**/ ?>