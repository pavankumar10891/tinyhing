                        ...
                        <div class="row">
                           ...
                           <div class="col-sm-4">
                            <div class="img-wall text-center">
                                <img src="<?php echo e(!empty($nannie['photo_id']) ? USER_IMAGE_URL.$nannie['photo_id'] : ''); ?>">
                            </div>
...
<?php echo $__env->make('front.dashboard.layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tinyhugs\resources\views/front/dashboard/cutomer_dashboard.blade.php ENDPATH**/ ?>