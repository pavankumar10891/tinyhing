					...
					<div class=" pb-2">
						<div class="">
							...
							<ul class="list-unstyled mb-4">
								...
								<?php if($features->optional == 1): ?>
								<li class="mb-2"><span class="mr-3">
									<i class="fas fa-check text-primary"></i></span><?php echo e($features->code); ?></li>
									<?php elseif($features->optional == 0): ?>             
									<li class="text-muted mb-2"><span class="mr-3"><i
										class="fas fa-times"></i></span><?php echo e($features->code); ?></li>
										<?php endif; ?>           
...
<?php echo $__env->make('front.layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tinyhugs\resources\views/front/users/usersignup.blade.php ENDPATH**/ ?>