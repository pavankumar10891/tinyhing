...
<div class="content  d-flex flex-column flex-column-fluid" id="kt_content">
	...
	<div class="d-flex flex-column-fluid">
		<!--begin::Container-->
		<div class=" container ">
			<?php echo e(Form::open(['method' => 'get','role' => 'form','url' => 'adminpnlx/email-manager','class' => 'kt-form kt-form--fit mb-0'])); ?>
					...
					<div class="card card-custom card-stretch card-shadowless">
						<div class="card-header">
							...
							<div class="card-toolbar">
								...
								<!--<a href='<?php echo e(route("EmailTemplate.add")); ?>'  class="btn btn-primary"> <?php echo e(trans("Add New Email Template")); ?> </a>-->
							</div>
						</div>
						<div class="card-body">
									...
									<div>
											...
											<div class="row mt-8">
												<div class="col-lg-12">
													...
													<a href='<?php echo e(route("EmailTemplate.index")); ?>'  class="btn btn-secondary btn-secondary--icon">
														<span>
												...
												<?php $__currentLoopData = $results; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $result): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
													<tr>
														...
														<td class="text-right pr-2">
															<a href='<?php echo e(route("EmailTemplate.edit","$result->id")); ?>'
...
<?php echo $__env->make('admin.layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp\htdocs\tinyhugs\resources\views/admin/emailtemplates/index.blade.php ENDPATH**/ ?>