        ...
        <div class="breadcrumb-block">
            <div class="container">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="<?php echo e(url('/our-nannies')); ?>">Our Nannies</a></li>
        ...
        <div class="container">
            <div class="profile-block" >
                ...
                <div class="row align-items-center">
                    <?php if(!empty($nannyProfile->photo_id) && file_exists(USER_IMAGE_ROOT_PATH.$nannyProfile->photo_id)): ?>
                    <div class="col-md-3">
                        <?php $image =  USER_IMAGE_URL.$nannyProfile->photo_id; ?>
                        <div class="img-wall" style="background-image: url(<?php echo e($image); ?>)">
                        ...
                        <div class="profile-info">
                            <div class="d-md-flex align-items-center">
                                <div class="heading d-flex pb-2 pb-md-0 ">
                                    <h4><?php echo e(!empty($nannyProfile->name) ? $nannyProfile->name:''); ?></h4>
                                    <span><?php echo e(!empty($nannyProfile->cpr_certificate) ? 'CPR Certificate'  : ''); ?></span>
                                </div>
                            ...
                            <ul>
                                ...
                                <li>
                                    ...
                                    <label><?php echo e(!empty($nannyProfile->city) ?$nannyProfile->city : ''); ?> <?php if($nannyProfile->city!='' AND $nannyProfile->state!='' ){ echo '/'; }  ?> <?php echo e(!empty($nannyProfile->state) ?$nannyProfile->state : ''); ?></label>
                                </li>
                                <?php   }  ?>
                                <?php if($nannyProfile->experience !=''){   ?>
                                <li>
                                 <label> Experience:</label>
                                <strong> <?php echo e($nannyProfile->experience.' Years'); ?></strong>
                               </li>
                               <?php   }  ?>
                            </ul>
                            <div class="stars">
                                <strong>
                                    <?php if(!empty($totalRatingCount)): ?>
                                            <?php echo e(round(($totalRating / $totalRatingCount), 1)); ?>

                                            <span class="satrimg">
                                            <img src="<?php echo e(WEBSITE_IMG_URL); ?>star.png">
                                            <img src="<?php echo e(WEBSITE_IMG_URL); ?>star.png">
                                            <img src="<?php echo e(WEBSITE_IMG_URL); ?>star.png">
                                            <img src="<?php echo e(WEBSITE_IMG_URL); ?>star.png">
                                            <img src="<?php echo e(WEBSITE_IMG_URL); ?>star.png">
                                ...
                                <span class="text"> (<?php echo e(($totalRatingCount > 0) ? $totalRatingCount:'0'); ?> Reviews)</span>
                            </div>
                            <p>
                                <?php echo e(!empty($nannyProfile->description) ? $nannyProfile->description  : ''); ?> </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-3 mb-md-3">
                            <div class="bg-white p-4">
                               <?php if(!empty($nannyProfile->cpr_certificate) ||  !empty($nannyProfile->other_certificates)  ): ?>
                              <a href="javascript:void(0)" data-toggle="modal" data-target="#exampleModal" > 
                                <div class="doc-block text-center mb-3">
                                    <img src="<?php echo e(WEBSITE_IMG_URL); ?>certificate.png">
                                    <h4>View All Certificate</h4>
                               </div>
                               </a>
                                <?php endif; ?> 
                                <?php if(!empty($nannyProfile->resume)): ?>
                                <?php ($resume = CERTIFICATES_AND_FILES_URL.$nannyProfile->resume  ); ?>
                                <a href="<?php echo e($resume); ?>" target="_blank"><div class="doc-block text-center">
                                    <img src="<?php echo e(WEBSITE_IMG_URL); ?>resume.png">
                                    <h4>View Resume</h4>
                                </div></a>
                                 <?php endif; ?>
                                    ...
                                    <div class="row">
                                        <div class="col-md-auto col-xl-4">
                                           ...
                                           <span>New Member</span>
                                            ...
                                            <?php endif; ?></strong>
                                                ...
                                                <span class="text">Based on <?php echo e(($totalRatingCount > 0) ? $totalRatingCount:'0'); ?> Reviews</span>
                                            </div>
                                        </div>
                                        <div class="col">
                                           ...
                                           <div class="progress-heading"> excellent</div>
                                            <div class="progress">
                                                ...
                                                <div class="progress-bar bg-success" role="progressbar"
                                                 style="width: <?php echo e($excellentRatingCount); ?>%" aria-valuenow="<?php echo e($excellentRatingCount); ?>" aria-valuemin="0" aria-valuemax="100"></div>
                                              </div>
                                        </div>
                                        ...
                                        <div class="progress-heading"> Good</div>
                                            <div class="progress">
                                                ...
                                                <div class="progress-bar bg-green" role="progressbar" style="width: <?php echo e($goodRatingCount); ?>%" aria-valuenow="<?php echo e($goodRatingCount); ?>" aria-valuemin="0" aria-valuemax="100"></div>
                                        ...
                                        <div class="progress">
                                                ...
                                                <div class="progress-bar bg-warning" role="progressbar" style="width: <?php echo e($averageRatingCount); ?>%" aria-valuenow="<?php echo e($averageRatingCount); ?>" aria-valuemin="0" aria-valuemax="100"></div>
                                        ...
                                        <div class="progress-block">
                                            ...
                                            <div class="progress">
                                                ...
                                                <div class="progress-bar bg-orange" role="progressbar" style="width: <?php echo e($belowaverageRatingCount); ?>%" aria-valuenow="<?php echo e($belowaverageRatingCount); ?>" aria-valuemin="0" aria-valuemax="100"></div>
                                              </div>    </div>
                                              ...
                                              <div class="progress">
                                               <div class="progress-bar bg-red" role="progressbar" style="width: <?php echo e($poorRatingCount); ?>%" aria-valuenow="<?php echo e($poorRatingCount); ?>" aria-valuemin="0" aria-valuemax="100"></div>
                                                 </div>
                                              </div>   
                                            </div>
                                        </div>
                      ...
                      <div class="review-block">
                        <div class="rating-block-heading pt-5">Ratings</div>
                                        ...
                                        <div class="card-horizontal no-gutters">
                                            <div class="col-auto">
                                                <div class="img-wall1">
                                                    <?php if(!empty(file_exists(USER_IMAGE_ROOT_PATH.$result->photo_id))): ?>
                                                    <img src="<?php echo e(WEBSITE_URL.'image.php?width=47&height=47&cropratio=3:3&image='.USER_IMAGE_URL.$result->photo_id); ?>" alt="">
                                                    <?php else: ?>
                                                    <img src="<?php echo e(WEBSITE_IMG_URL); ?>profile-2.png" class="img-fluid">
                                                    <?php endif; ?>

                                                </div>
                                                <h4 class="card-title"><?php echo e(!empty($result->name) ? $result->name:''); ?></h4>
                                                <span>
                                            ...
                                            <div class="col pl-lg-3">
                                                    ...
                                                    <?php echo e(!empty($result->created_at) ? date('m/d/Y h:i a',strtotime($result->created_at)):''); ?>
                                                ...
                                                <p class="card-text">
                                                   <?php echo !empty($result->review) ? $result->review:''; ?></p>
                                            </div>
                                        </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
           <?php if(!empty($nannyProfile->cpr_certificate)): ?>
            <?php ($crp = CERTIFICATES_AND_FILES_URL.$nannyProfile->cpr_certificate  ); ?>
            <h5>CRP Certificte</h5>
            <a href="<?php echo e($crp); ?>" target="_blank"><div class="doc-block text-center">
                <img src="<?php echo e(WEBSITE_IMG_URL); ?>resume.png">
                <h4>View Certificte</h4>
            </div></a>
            <?php endif; ?>

            <?php if(!empty($nannyProfile->other_certificates)): ?>
            <?php $__currentLoopData = $nannyProfile->other_certificates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $otherCertificate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php ($othercrp = OTHER_CERTIFICATES_DOCUMENT_URL.$otherCertificate->other_certificates  ); ?>
            <h5>Other Certifictes</h5>
            <a href="<?php echo e($othercrp); ?>" target="_blank"><div class="doc-block text-center">
                <img src="<?php echo e(WEBSITE_IMG_URL); ?>resume.png">
                <h4>View Certificte</h4>
            </div></a>
            <?php ($othercrp =  ''); ?>
            ...
            <div class="modal-body">
                ...
                <label>Name</label>
                    <div class="theme_input">
                       <?php echo e(Form::text('first_name', (! empty(Request::old('first_name'))) ? Request::old('first_name') : '', ['placeholder' => trans("Name"), 'class'=>'form-control'])); ?>
                ...
                <label>Email</label>
                    <div class="theme_input">
                       <?php echo e(Form::text('email', (! empty(Request::old('email'))) ? Request::old('email') : '', ['placeholder' => trans("Email"), 'class'=>'form-control'])); ?>
                ...
                <label>Phone (optional)</label>
                    <div class="theme_input">
                       <?php echo e(Form::text('phone_number', (! empty(Request::old('phone_number'))) ? Request::old('phone_number') : '', ['placeholder' => trans("Phone Number"), 'class'=>'form-control'])); ?>
...
function signUp(){
    ...
    $.ajax({
        url: "<?php echo e(route('user.userCheckInfo')); ?>",
        method: 'post',
...
<script>
        ...
        //    var id  =  document.getElementsByClassName('nanny')[0].value;
           ...
           if(nannyId!=''){
           $.ajax({
                url    : '<?php echo e(route("user.time.slots")); ?>',
                method : "POST",
        ...
        $(".add_holiday").click(function(){
                ...
                $.ajax({
                url    : '<?php echo e(route("user.schedule.interview")); ?>',
                method : "POST",
...
<?php echo $__env->make('front.layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp\htdocs\tinyhugs\resources\views/front/pages/nanny-profile.blade.php ENDPATH**/ ?>