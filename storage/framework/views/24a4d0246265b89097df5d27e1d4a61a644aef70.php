...
<?php if($segment != 'meeting-join'): ?>
    <?php if(!empty(Auth::user())): ?>
        ...
        <?php endif; ?>
    <?php endif; ?>
<?php endif; ?><?php /**PATH F:\xampp\htdocs\tinyhugs\resources\views/front/dashboard/elements/dashboard_header.blade.php ENDPATH**/ ?>