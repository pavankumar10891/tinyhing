...
<div class="main-workspace">
            ...
            <div class="container">
                ...
                <script>
                    var API_KEY = "<?php echo env("ZOOM_CLIENT_KEY");?>";
                    ...
                    */
                    var API_SECRET = "<?php echo env("ZOOM_CLIENT_SECRET");?>";
                    ...
                    var testTool = {
                        ...
                        getMeetingConfig: function () {
                            return {
                                mn: parseInt(<?php echo $result->meeting_number; ?>),
                                name: testTool.b64EncodeUnicode("<?php echo Auth::user()->name; ?>"),
                                pwd: "<?php echo $result->meeting_password; ?>",
                                role: parseInt(0, 10),
                                email: testTool.b64EncodeUnicode("<?php echo Auth::user()->email ?>"),
                                lang: 'en-US',
                                signature: "",
                                china: 0,
                            };
                ...
                <script src="<?php echo WEBSITE_JS_URL; ?>vconsole.min.js"></script>
                <!-- <script src="<?php echo WEBSITE_JS_URL; ?>meeting.js"></script> -->
                <script>
                window.addEventListener('DOMContentLoaded', function(event) {
                    console.log('DOM fully loaded and parsed');
                    websdkready();
                ...
                function websdkready() {
                    ...
                    var meetingConfig = {
                        apiKey: API_KEY,
                        meetingNumber: parseInt(<?php echo $result->meeting_number; ?>),
                        userName: (function () {
                        if (tmpArgs.name) {
                            try {
                                return ''
                        ...
                        return (
                            testTool.b64DecodeUnicode(testTool.b64EncodeUnicode("<?php echo Auth::user()->name; ?>"))
                        );
                        })(),
                        passWord: "<?php echo $result->meeting_password; ?>",
                        <?php if(Auth::user()->user_role_id == 2){ ?>
                        leaveUrl: "<?php echo e(route('user.clientInterviewList')); ?>",
                        <?php } ?>
                        <?php if(Auth::user()->user_role_id == 3){ ?>
                        leaveUrl: "<?php echo e(route('user.nannyInterviewList')); ?>",
                        <?php } ?>
                        role: parseInt(0, 10),
                        userEmail: (function () {
                        try {   
                            return testTool.b64DecodeUnicode("<?php echo Auth::user()->email; ?>");
                        } catch (e) {
                            return '';
                        }
                        })(),
...
<?php echo $__env->make('front.dashboard.layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp\htdocs\tinyhugs\resources\views/front/dashboard/zoom.blade.php ENDPATH**/ ?>