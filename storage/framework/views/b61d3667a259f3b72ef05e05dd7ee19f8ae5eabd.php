                                    ...
                                    <div>
                                        <div class="row mb-6">
                                            ...
                                            <div class="col-lg-4 mb-lg-5 mb-6">
                                                <label>Price</label>
                                                <?php echo e(Form::text('price',((isset($searchVariable['price'])) ? $searchVariable['price'] : ''), ['class' => ' form-control','placeholder'=>'Price'])); ?>

                                            </div>
                                            <div class="col-lg-4 mb-lg-5 mb-6">
                                                <label>Country</label><br>
                                                <?php echo e(Form::select('country_id',array(''=>trans('Select Country'))+$countries,((isset($searchVariable['country_id'])) ? $searchVariable['country_id'] : ''), ['class' => 'form-control chosenselect'])); ?>
                                    ...
                                    <table
                                        ...
                                        <thead>
                                            <tr class="text-uppercase">
                                                <th
                                                    class="<?php echo e((($sortBy == 'country_name' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'country_name' && $order == 'asc') ? 'sorting_asc' : 'sorting'))); ?>">
                                                ...
                                                <th
                                                    class="<?php echo e((($sortBy == 'price' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'price' && $order == 'asc') ? 'sorting_asc' : 'sorting'))); ?>">
                                                    <?php echo e(link_to_route(
															"$modelName.index",
															trans("Price"),
                                                            array(
...
<?php echo $__env->make('admin.layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp\htdocs\tinyhugs\resources\views/admin/price/index.blade.php ENDPATH**/ ?>