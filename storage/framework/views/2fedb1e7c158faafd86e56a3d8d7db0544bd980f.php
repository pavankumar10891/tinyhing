...
<div class="content  d-flex flex-column flex-column-fluid" id="kt_content">
	...
	<div class="d-flex flex-column-fluid">
		<!--begin::Container-->
		<div class=" container ">
			<?php echo e(Form::open(['role' => 'form','url' => 'adminpnlx/email-manager/add-template','class' => 'mws-form'])); ?>
											...
											<div class="row">
												<div class="col-xl-6">
													...
													<div class="form-group">
														<?php if($i == 1): ?>
															...
															<?php echo e(Form::text("data[$language->id][name]","", ['class' => 'form-control form-control-solid form-control-lg '.($errors->has('name') ? 'is-invalid':'')])); ?>
														...
														<?php else: ?>
															...
															<?php echo e(Form::text("data[$language->id][name]","", ['class' => 'form-control form-control-solid form-control-lg '])); ?>
												...
												<div class="col-xl-6">
													...
													<div class="form-group">
														<?php if($i == 1): ?>
															...
															<?php echo e(Form::text("data[$language->id][subject]","", ['class' => 'form-control form-control-solid form-control-lg '.($errors->has('subject') ? 'is-invalid':'')])); ?>
														...
														<?php else: ?>
															...
															<?php echo e(Form::text("data[$language->id][subject]","", ['class' => 'form-control form-control-solid form-control-lg '])); ?>
												...
												<div class="col-xl-6">
													<div class="form-group">
														...
														<a onclick = "return InsertHTML(<?php echo e($i); ?>)" href="javascript:void(0)" class="btn  btn-success no-ajax pull-right"><i class="icon-white "></i><?php echo e(trans("Insert Variable")); ?> </a>
													</div>
												...
												<div class="col-xl-12">
													...
													<div class="form-group">
														...
														<?php if($i == 1): ?>
															...
															<?php echo e(Form::textarea("data[$language->id][body]","", ['class' => 'form-control form-control-solid form-control-lg '.($errors->has('body') ? 'is-invalid':''),'id' => 'body'])); ?>
														...
														<?php else: ?>
															...
															<?php echo e(Form::textarea("data[$language->id][body]","", ['class' => 'form-control form-control-solid form-control-lg','id' => 'body'])); ?>
...
<?php echo $__env->make('admin.layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp\htdocs\tinyhugs\resources\views/admin/emailtemplates/add.blade.php ENDPATH**/ ?>