                                    ...
                                    <div>
                                        <div class="row mb-6">
                                            ...
                                            <div class="col-lg-4 mb-lg-5 mb-6">
                                                ...
                                                <?php echo e(Form::text('coupon_code',((isset($searchVariable['coupon_code'])) ? $searchVariable['coupon_code'] : ''), ['class' => ' form-control','placeholder'=>'Coupon Code'])); ?>

                                            </div>
                                            <div class="col-lg-4 mb-lg-5 mb-6">
                                                <label>Coupon Type</label>
                                                <?php echo e(Form::select('coupon_type',array(''=>trans('All'),'fixed_amount'=>trans('Fixed Amount'),'percentage'=>trans('Percentage')),((isset($searchVariable['coupon_type'])) ? $searchVariable['coupon_type'] : ''), ['class' => 'form-control'])); ?>
                                    ...
                                    <table
                                        ...
                                        <thead>
                                            <tr class="text-uppercase">
                                                <th
                                                    class="<?php echo e((($sortBy == 'coupon_code' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'coupon_code' && $order == 'asc') ? 'sorting_asc' : 'sorting'))); ?>">
                                                    <?php echo e(link_to_route(
															"$modelName.index",
															trans("Coupon Code"),
															array(
															'sortBy' => 'coupon_code',
															'order' => ($sortBy == 'coupon_code' && $order == 'desc') ? 'asc' : 'desc',
															$query_string
															)
														)); ?>
                                                ...
                                                <th
                                                    class="<?php echo e((($sortBy == 'coupon_type' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'coupon_type' && $order == 'asc') ? 'sorting_asc' : 'sorting'))); ?>">
                                                    <?php echo e(link_to_route(
															"$modelName.index",
															trans("Coupon Type"),
                                                            array(
															'sortBy' => 'coupon_type',
															'order' => ($sortBy == 'coupon_type' && $order == 'desc') ? 'asc' : 'desc',
															$query_string
															)
														)); ?>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="text-dark-75 mb-1 font-size-lg">
                                                    <?php if($result->coupon_type == 'fixed_amount'): ?>
                                                        <span class="label-primary" >	<?php echo e(strtoupper($result->coupon_type)); ?></span>
                                                    <?php else: ?>
                                                        <span class="label-info" ><?php echo e(strtoupper($result->coupon_type)); ?></span>
                                                    <?php endif; ?>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="text-dark-75 mb-1 font-size-lg">
                                                        ...
                                                        <?php if($result->coupon_type == 'percentage'): ?> % <?php endif; ?>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="text-dark-75 mb-1 font-size-lg">
                                                        <?php echo e((!empty($result->start_date) && $result->start_date != "0000-00-00") ? date(Config::get("Reading.date_format"),strtotime($result->start_date)) : ''); ?>

                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="text-dark-75 mb-1 font-size-lg">
                                                        <?php echo e((!empty($result->end_date) && $result->end_date != "0000-00-00") ? date(Config::get("Reading.date_format"),strtotime($result->end_date)) : ''); ?>
...
<?php echo $__env->make('admin.layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tinyhugs\resources\views/admin/CouponCodes/index.blade.php ENDPATH**/ ?>