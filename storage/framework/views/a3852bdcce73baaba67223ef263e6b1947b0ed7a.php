            ...
            <div class="row pb-md-5 pb-3 flex-row">
                <div class="col">
                    ...
                    <div class="col-md-auto">
                       <div class="create-account"> Not a member? <a href="<?php echo e(route('user.pricing')); ?>">Sign up   </a></div>
                    </div>
            </div>
            <div class="form-bx">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('front.layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tinyhugs\resources\views/front/users/client_login.blade.php ENDPATH**/ ?>