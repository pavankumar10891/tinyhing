                                    ...
                                    <div>
                                        <div class="row mb-6">
                                            <div class="col-lg-4 mb-lg-5 mb-6">
                                                <label>Status</label>
                                                <?php echo e(Form::select('is_active',array(''=>trans('All'),0=>trans('Pending'),1=>trans('Accepted'), 2 => trans('Stopped'), 3=>trans('Rejected')),((isset($searchVariable['is_active'])) ? $searchVariable['is_active'] : ''), ['class' => 'form-control select2init'])); ?>

                                            </div>
                                            <div class="col-lg-4 mb-lg-5 mb-6">
                                                <label>Nanny</label>
                                                <?php echo e(Form::text('nanny',((isset($searchVariable['nanny'])) ? $searchVariable['nanny'] : ''), ['class' => ' form-control','placeholder'=>'Nanny'])); ?>

                                            </div>
                                            <div class="col-lg-4 mb-lg-5 mb-6">
                                                <label>Customer</label>
                                                <?php echo e(Form::text('customer',((isset($searchVariable['customer'])) ? $searchVariable['customer'] : ''), ['class' => ' form-control','placeholder'=>'Customer'])); ?>
                                    ...
                                    <table
                                        ...
                                        <thead>
                                            <tr class="text-uppercase">
                                                <th
                                                    class="<?php echo e((($sortBy == 'customer' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'customer' && $order == 'asc') ? 'sorting_asc' : 'sorting'))); ?>">
                                                    <?php echo e(link_to_route(
															"$modelName.index",
															trans("Customer"),
															array(
															'sortBy' => 'customer',
															'order' => ($sortBy == 'customer' && $order == 'desc') ? 'asc' : 'desc',
															$query_string
															)
														)); ?>
                                                ...
                                                <th
                                                    class="<?php echo e((($sortBy == 'nanny' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'nanny' && $order == 'asc') ? 'sorting_asc' : 'sorting'))); ?>">
                                                    <?php echo e(link_to_route(
															"$modelName.index",
															trans("Nannay"),
															array(
															'sortBy' => 'nanny',
															'order' => ($sortBy == 'nanny' && $order == 'desc') ? 'asc' : 'desc',
															$query_string
															)
														)); ?>
                                                ...
                                                <th
                                                    class="<?php echo e((($sortBy == 'booking_date' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'booking_date' && $order == 'asc') ? 'sorting_asc' : 'sorting'))); ?>">
                                                    <?php echo e(link_to_route(
															"$modelName.index",
															trans("Booking Date"),
                                                            array(
                                                ...
                                                <th
                                                    class="<?php echo e((($sortBy == 'start_date' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'start_date' && $order == 'asc') ? 'sorting_asc' : 'sorting'))); ?>">
                                                    <?php echo e(link_to_route(
															"$modelName.index",
															trans("Start Date"),
                                                            array(
                                                ...
                                                <th
                                                    class="<?php echo e((($sortBy == 'end_date' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'end_date' && $order == 'asc') ? 'sorting_asc' : 'sorting'))); ?>">
                                                    <?php echo e(link_to_route(
															"$modelName.index",
															trans("End Date"),
                                                            array(
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="text-dark-75 mb-1 font-size-lg">
                                                        <?php echo e($result->customer); ?>

                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="text-dark-75 mb-1 font-size-lg">
                                                        <?php echo e($result->nanny); ?>

                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="text-dark-75 mb-1 font-size-lg">
                                                        <?php echo e((!empty($result->booking_date) && $result->booking_date != "0000-00-00") ? date(Config::get("Reading.date_format"),strtotime($result->booking_date)) : ''); ?>

                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="text-dark-75 mb-1 font-size-lg">
                                                       <?php echo e(!empty($result->start_date) ? date('d-m-Y',strtotime($result->start_date)):''); ?>

                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="text-dark-75 mb-1 font-size-lg">
                                                       <?php echo e(!empty($result->end_date) ? date('d-m-Y',strtotime($result->end_date)):''); ?>
                                                ...
                                                <td>
                                                    ...
                                                    <span
                                                        class="label label-lg label-light-warning label-inline">Pending</span>
                                                    <?php elseif($result->is_active == 1): ?>
                                                    <span
                                                        class="label label-lg label-light-success label-inline">Accepted</span>
                                                     <?php elseif($result->is_active == 2): ?>
                                                    <span
                                                        class="label label-lg label-light-info label-inline">Stopped</span>
                                                     <?php else: ?>
                                                    <span
                                                        class="label label-lg label-light-danger label-inline">Reject</span>
                                                    <?php endif; ?>
                                                </td>
                                                <td class="text-right pr-2">
                                                    ...
                                                    <a title="Click To Deactivate"
                                                        href='{{route("$modelName.status",array($result->id))}}'
...
<?php echo $__env->make('admin.layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp\htdocs\tinyhugs\resources\views/admin/booking/index.blade.php ENDPATH**/ ?>