			...
			<div class="sortby">
				<form action="" id="sor_by_form" method="get" >
					...
					<div  style="float:right">
						<select name="nanny_type" class="form-control">
							<option value="1">Nanny</option>
							<option value="2" <?php echo e(isset($_REQUEST['type']) &&  $_REQUEST['type'] == 'babbysitter' ? 'selected':''); ?>>Babbysitter</option>
							<option value="3" <?php echo e(isset($_REQUEST['type']) &&  $_REQUEST['type'] == 'both' ? 'selected':''); ?>>Both</option>
						</select>
						</div>
				</form>
			</div>
			<div class="listing padding-bottom">
				...
				<div class="row listingnanny">
					<?php if(!$lists->isEmpty()): ?>
						<?php $__currentLoopData = $lists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $listsk=>$listsv): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							<div class="col-sm-6 col-lg-4 mb-md-5 mb-4">
								<a href="<?php echo e(route('user.nanny.profile', base64_encode($listsv->id))); ?>">
									<div class="bg-white mr-md-auto">
										...
										<div class="img-wall" style="background-image: url(<?php echo e($image); ?>)">
											<img src="<?php echo e(WEBSITE_URL.'image.php?width=253px&height=226px&cropratio=3:2&image='.$image); ?>" class="w-100" alt="">
										</div>
										<div class="text-block">
											<div class="d-flex align-items-center">
												<h3><?php echo e(!empty($listsv->name) ? $listsv->name:''); ?></h3>
												<div class="rating-block">
													...
													<?php if(!empty($listsv->total_rating)): ?>
													<?php echo e(round(($listsv->total_rating / $listsv->total_rating_count), 1)); ?>
											...
											<ul class="">
												<li> <label>Age:</label><strong><?php echo e(!empty($listsv->age) ? $listsv->age  : 'N/A'); ?></strong> </li>
												<li> <label>City:</label><strong><?php echo e(!empty($listsv->city) ? $listsv->city  : 'N/A'); ?></strong> </li>
												<li> <label> Exp:</label><strong><?php echo e(!empty($listsv->experience) ? $listsv->experience.' Years'  : 'N/A'); ?> </strong></li>
											</ul>
											<div class="">
												<p><?php echo e(!empty($listsv->description) ? $listsv->description  : ''); ?></p>
											</div>
										</div>
										<input type="hidden" name="nanny" class="nanny" value="<?php echo e($listsv->id); ?>">
										<div class="btn-block mt-1 text-center">
											<?php if(!empty(Auth::user())): ?>
												<a href="javascript:void(0);" class="btn-theme mw-100 schedule_interview" id="<?php echo e($listsv->id); ?>" >
													Schedule Interview
												</a>
											<?php else: ?>
												<a href="javascript:void(0);" class="btn-theme mw-100 nanny_interview" id="<?php echo e($listsv->id); ?>" >
													Schedule Interview
												</a>
											<?php endif; ?>
										</div>
					...
					<?php else: ?>
						<div class="col-sm-12">
							<p class="text-center"  style="font-size: 24px;font-weight: bold;">No Record Found</p>					
						</div>
					<?php endif; ?>
                </div>
			</div>
	...
	<div class="modal-dialog modal-dialog-centered">
		<div class="modal-content">
			...
			<div class="modal-body">
                ...
                <!-- <div class="form-group">
                    <div class="theme_input">
                       <?php echo e(Form::text('last_name', (! empty(Request::old('last_name'))) ? Request::old('last_name') : '', ['placeholder' => trans("Last Name"), 'class'=>'form-control'])); ?>
               ...
               <!-- <div class="form-group">
                    <div class="theme_input">
                       <?php echo e(Form::text('postcode', (! empty(Request::old('postcode'))) ? Request::old('postcode') : '', ['placeholder' => trans("Post Code"), 'class'=>'form-control'])); ?>
...
<script>
	...
	function getMoreJobs(){
		...
		$.ajax({
			...
			url         :   '<?php echo e(url("nanny-loadmore/")); ?>',
			type        :   'POST', 
			data        :   {'offset':offset},              
	...
	$(document).ready(function () {
		...
		$("body").on('click', '.nanny_interview',function(){	
			$('#myModal').modal('show');
...
<?php endif; ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('front.layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp\htdocs\tinyhugs\resources\views/front/pages/nanny_listing.blade.php ENDPATH**/ ?>