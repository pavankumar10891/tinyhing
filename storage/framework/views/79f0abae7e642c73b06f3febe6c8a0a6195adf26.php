            ...
            <div class="row pb-md-5 pb-3 flex-row">
                <div class="col">
                    ...
                    <div class="col-md-auto">
                       <div class="create-account"> Not a member? <a href="<?php echo e(route('user.pricing')); ?>" style="color: #ffd500;">Sign up   </a></div>
                    </div>
            </div>
            <div class="form-bx">
   
             <div class="social-login ">
                 <a href="<?php echo e(url('/login/client/google')); ?>" class="g-login">
                    <img src="<?php echo e(WEBSITE_IMG_URL); ?>google-icon.jpg">  Login with Google
                </a>
                <a href="<?php echo e(url('/login/client/facebook')); ?>" class="fb-login">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('front.layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp\htdocs\tinyhugs\resources\views/front/users/client_login.blade.php ENDPATH**/ ?>