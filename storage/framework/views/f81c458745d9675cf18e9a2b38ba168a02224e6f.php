	...
	<div class="col-sm-12 col-md-7">
		<div class="d-flex justify-content-end align-items-center">
			<div class="dataTables_length mr-4">
				<label class="mb-0">
					Show 
					<?php echo e(Form::select('per_page',[config::get("Reading.record_per_page") => 'Default'] + Config::get('per_page'),((isset($searchVariable['per_page'])) ? $searchVariable['per_page'] : ''), ['class' => 'custom-select custom-select-sm form-control form-control-sm','onchange'=>'page_limit()','id'=>'per_page'])); ?>
				...
				<div class="dataTables_paginate paging_full_numbers">
					<ul class="pagination">
						...
						<?php for($i = 1; $i <= $results->lastPage(); $i++): ?>
							...
							?>
							<?php if($from < $i && $i < $to): ?>
								<li class="paginate_button page-item <?php echo e(($results->currentPage() == $i) ? ' active' : ''); ?>">
...
</div><?php /**PATH F:\xampp\htdocs\tinyhugs\resources\views/pagination/default.blade.php ENDPATH**/ ?>