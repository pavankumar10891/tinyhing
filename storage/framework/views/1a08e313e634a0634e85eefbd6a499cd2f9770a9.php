                                        ...
                                        <div class="row mb-6">
                                           <?php  $allplans 	=   CustomHelper::getAllPlans('standard ');       ?>
                                            ...
                                            <div class="col-lg-4 mb-lg-5 mb-6">
                                                <label>Plans</label>
                                                <?php echo e(Form::select('plans',$allplans,((isset($searchVariable['plans'])) ? $searchVariable['plans'] : ''), ['class' => ' form-control','placeholder'=>'Select Plans'])); ?>
                                    ...
                                    <table
                                        ...
                                        <thead>
                                            <tr class="text-uppercase">
                                                ...
                                                <th
                                                    class="<?php echo e((($sortBy == 'plan_name' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'plan_name' && $order == 'asc') ? 'sorting_asc' : 'sorting'))); ?>">
                                                    <?php echo e(link_to_route(
															"$modelName.index",
															trans("Plan Name"),
															array(
...
<?php echo $__env->make('admin.layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp\htdocs\tinyhugs\resources\views/admin/UserPlans/index.blade.php ENDPATH**/ ?>