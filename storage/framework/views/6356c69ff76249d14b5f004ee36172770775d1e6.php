...
function showMore($elem){
        $elem.hide();
 		...
 		$.ajax({
 			...
 			url: '<?php echo e(route("user.nannyNotificationList")); ?>',
 			data: {
 				'offset': offset
 			},
 			type: "POST",
...
<?php echo $__env->make('front.dashboard.layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp\htdocs\tinyhugs\resources\views/front/dashboard/nanny_notification.blade.php ENDPATH**/ ?>