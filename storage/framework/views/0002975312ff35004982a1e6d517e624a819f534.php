                                    ...
                                    <div>
                                        <div class="row mb-6">
                                            ...
                                            <div class="col-lg-4 mb-lg-5 mb-6">
                                                ...
                                                <?php echo e(Form::text('phone',((isset($searchVariable['phone_number'])) ? $searchVariable['phone_number'] : ''), ['class' => ' form-control','placeholder'=>'Phone Number'])); ?>
                                    ...
                                    <table
                                        ...
                                        <thead>
                                            <tr class="text-uppercase">
                                                <th
                                                    class="<?php echo e((($sortBy == 'nanny_type' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'nanny_type' && $order == 'asc') ? 'sorting_asc' : 'sorting'))); ?>">
                                                    <?php echo e(link_to_route(
                                                            "$modelName.index",
                                                            trans("Type"),
                                                            array(
                                                            'sortBy' => 'nanny_type',
                                                            'order' => ($sortBy == 'nanny_type' && $order == 'desc') ? 'asc' : 'desc',
                                                            $query_string
                                                            )
                                                        )); ?>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="text-dark-75 mb-1 font-size-lg">
                                                         <?php if($result->nanny_type == 1): ?>
                                                         Nanny
                                                         <?php elseif($result->nanny_type == 2): ?>
                                                         Babbysitter
                                                         <?php elseif($result->nanny_type == 3): ?>
                                                         Both(Nanny, Babbysitter)
                                                         <?php endif; ?>
                                                    </div>
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    ...
                                                    <?php else: ?>
                                                    <span
                                                        class="label label-lg label-light-warning label-inline">Approval 
                                                        Pending</span>
                                                    <?php endif; ?>
                                                </td>
                                                <td class="text-right pr-2">
                                                    <?php if($result->is_approved == 0): ?>
                                                    <a title="Click To Approve"
                                                        href='<?php echo e(route("$modelName.senduserverification",array($result->id,1))); ?>'
                                                        class="btn btn-icon btn-light btn-hover-success btn-sm status_any_item"
                                                        data-toggle="tooltip" data-placement="top" data-container="body"
                                                        data-boundary="window" data-original-title="Click To Approve">
                                                    ...
                                                    <a title="Click to Reject"
                                                        href='<?php echo e(route("$modelName.senduserverification",array($result->id,2))); ?>'
                                                    ...
                                                    <div class="dropdown dropdown-inline">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                                                            <ul class="nav nav-hoverable flex-column">
                                                                <li class="nav-item">
                                                                    <a class="nav-link"
                                                                        href='<?php echo e(route("$modelName.verification","$result->id")); ?>'>
                                                                        <span class="nav-text">Send Verification
                                                                            Mail</span>
                                                                    </a>
                                                                </li>
                                                            </ul>
...
<?php echo $__env->make('admin.layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp\htdocs\tinyhugs\resources\views/admin/Nanny/index.blade.php ENDPATH**/ ?>