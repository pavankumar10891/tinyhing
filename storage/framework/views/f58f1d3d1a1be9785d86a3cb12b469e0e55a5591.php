   ...
   <div class="container">
      <div class="dashboard-profile">
                    <div class="dashboard-block">
                        ...
                        <?php echo e(Form::open(array('id' => 'customer-edit-form', 'class' => 'form'))); ?>

                            <div class="row align-items-center">
                                <div class="col-auto">
                                    <div class="img-wall1">
                                    <?php if(!empty($user_data->photo_id) ): ?>
                         ...
                         <div class="edit-profile-heading py-0 my-4">User Information</div>
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <?php echo e(Form::text('name', ( !empty($user_data->name)  ? $user_data->name : '' ), ['class' => 'form-control', 'placeholder' => 'Name'])); ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group input-form mw-100">
                                    <?php echo e(Form::text('postcode', ( !empty($user_data->postcode)  ? $user_data->postcode : '' ), ['class' => 'form-control', 'placeholder' => 'Zipcode'])); ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group input-form mw-100">
                                    <?php echo e(Form::text('city', ( !empty($user_data->city)  ? $user_data->city : '' ), ['class' => 'form-control', 'placeholder' => 'City'])); ?>

                                    <span id="city_error" class="help-inline error"></span>
                                    </div>
                                </div> <div class="col-md-6">
                                    <div class="form-group input-form mw-100">
                                    <?php echo e(Form::text('state', ( !empty($user_data->state)  ? $user_data->state : '' ), ['class' => 'form-control', 'placeholder' => 'State'])); ?>
...
<?php echo $__env->make('front.dashboard.layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp\htdocs\tinyhugs\resources\views/front/dashboard/customer_profile.blade.php ENDPATH**/ ?>