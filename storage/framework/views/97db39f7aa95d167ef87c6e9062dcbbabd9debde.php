                            ...
                            <div class="row">
                                <div class="col-xl-6">
                                    ...
                                    <div class="form-group">
                                        <?php echo HTML::decode( Form::label('coupon_code', trans("Coupon Code").'<span
                                            class="text-danger"> * </span>')); ?>

                                        <?php echo e(Form::text('coupon_code','', ['class' => 'form-control form-control-solid form-control-lg '.($errors->has('coupon_code') ? 'is-invalid':'')])); ?>
                                ...
                                <div class="col-xl-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group date" id="datepickerfrom" data-target-input="nearest">
                                            <?php echo e(Form::text('start_date','', ['class' => 'form-control form-control-solid form-control-lg datetimepicker-input '.($errors->has('start_date') ? 'is-invalid':''),'placeholder'=>'Valid From','data-target'=>'#datepickerfrom','data-toggle'=>'datetimepicker'])); ?>
                                ...
                                <div class="col-xl-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group date" id="datepickerto" data-target-input="nearest">
                                            <?php echo e(Form::text('end_date','',['class' => 'form-control form-control-solid form-control-lg datetimepicker-input '.($errors->has('end_date') ? 'is-invalid':''),'placeholder'=>'Valid To','data-target'=>'#datepickerto','data-toggle'=>'datetimepicker'])); ?>
                                ...
                                <div class="col-xl-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::text('amount','', ['class' => 'form-control form-control-solid form-control-lg '.($errors->has('amount') ? 'is-invalid':'')])); ?>
                                        ...
                                        <?php echo HTML::decode( Form::label('coupon_type', trans("Coupon Type").'<span
                                            ...
                                            <?php if(!empty($couponTypeArr)): ?>
                                                <?php $__currentLoopData = $couponTypeArr; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $couponKey => $couponVal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <?php echo e(Form::radio('coupon_type',$couponKey,false,['class'=>'' .($errors->has('coupon_type') ? 'is-invalid':''), 'id' => "coupon_".$couponKey])); ?>
...
<?php echo $__env->make('admin.layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tinyhugs\resources\views/admin/CouponCodes/add.blade.php ENDPATH**/ ?>