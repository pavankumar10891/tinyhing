                            ...
                            <div class="row">
                                <div class="col-xl-6">
                                    ...
                                    <div class="form-group">
                                        <?php echo HTML::decode( Form::label('amount', trans("Amount").'<span class="text-danger">
                                            * </span>')); ?>
...
<?php echo $__env->make('admin.layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp\htdocs\tinyhugs\resources\views/admin/Payout/edit.blade.php ENDPATH**/ ?>