    ...
    <script>
        ...
        var testTool = {
            ...
            getMeetingConfig: function () {
                return {
                mn: parseInt(<?php echo $result->zoom_id; ?>),
                name: testTool.b64EncodeUnicode("<?php echo Auth::guard('admin')->user()->name; ?>"),
                pwd: "<?php echo $result->zoom_password; ?>",
                role: parseInt(0, 10),
                email: testTool.b64EncodeUnicode("<?php echo Auth::guard('admin')->user()->email; ?>"),
                lang: 'en-US',
                signature: "",
                china: 0,
                };
...
<?php echo $__env->make('admin.layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp\htdocs\tinyhugs\resources\views/admin/ScheduleInterview/zoom.blade.php ENDPATH**/ ?>