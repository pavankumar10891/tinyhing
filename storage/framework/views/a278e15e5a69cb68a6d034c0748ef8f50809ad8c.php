													...
													<td>
                                                        ...
                                                        <?php if($result->image != ""): ?>
																	...
																	<a class="fancybox-buttons" data-fancybox-group="button" href="<?php echo e($result->image); ?>">
																		<img class="" src="<?php echo e($result->image); ?>" width="50px" height="50px">
																	</a>
																<?php endif; ?>
															</div>
														</td>
...
<?php echo $__env->make('admin.layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp\htdocs\tinyhugs\resources\views/admin/SystemDocument/index.blade.php ENDPATH**/ ?>