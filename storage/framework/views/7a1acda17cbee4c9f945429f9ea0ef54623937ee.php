...
<div class="items py-md-5 ">
    <ul>
        ...
        <li class="<?php echo e(($segment == 'notification-client'  )? 'active': ''); ?>">
            <a href="<?php echo e(route('user.clientNotificationList')); ?>">
        ...
        <li class="<?php echo e(($segment == 'inbox-client'  )? 'active': ''); ?>">
            <a href="<?php echo e(route('user.clientInboxList')); ?>">
        ...
        <li class="<?php echo e(($segment == 'my-booking-client'  )? 'active': ''); ?>">
            <a href="<?php echo e(route('user.clientBookingList')); ?>">
        ...
        <li class="<?php echo e(($segment == 'my-earning-client'  )? 'active': ''); ?>">
            <a href="<?php echo e(route('user.clientEarningList')); ?>">
        ...
        <li class="<?php echo e(($segment == 'my-invoice'  )? 'active': ''); ?>">
            <a href="<?php echo e(route('user.invoice')); ?>">
                <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="wallet" role="img"
                    xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"
                    class="svg-inline--fa fa-wallet fa-w-16 fa-3x">
                    <path fill="currentColor"
        ...
        <?php endif; ?>
        <li class="<?php echo e(($segment == 'ratings-client'  )? 'active': ''); ?>">
            <a href="<?php echo e(route('user.clientRatingList')); ?>">
        ...
        <li class="<?php echo e(($segment == 'interviews-client'  )? 'active': ''); ?>">
            <a href="<?php echo e(route('user.clientInterviewList')); ?>">
        ...
        <li class="<?php echo e(($segment == 'my-plan'  )? 'active': ''); ?>">
            <a href="<?php echo e(route('user.myPlanDetail')); ?>">
                <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="calendar-alt"
                    role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"
                    class="svg-inline--fa fa-calendar-alt fa-w-14 fa-2x">
                    <path fill="currentColor"
        ...
        <li class="<?php echo e(($segment == 'payment-setting'  )? 'active': ''); ?>">

            <a href="<?php echo e(route('user.payment-setting')); ?>">
        ...
        <li class="<?php echo e(($segment == 'support-chat'  )? 'active': ''); ?>">
            <a href="<?php echo e(URL::to('support-chat')); ?>">
        ...
        <li class="<?php echo e(($segment == 'logout'  )? 'active': ''); ?>">
...
</div><?php /**PATH F:\xampp\htdocs\tinyhugs\resources\views/front/dashboard/elements/customer_sidebar.blade.php ENDPATH**/ ?>