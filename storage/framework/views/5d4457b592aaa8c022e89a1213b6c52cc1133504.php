            ...
            <div class="row align-items-center py-2">
                <div class="col-md-12 text-md-right text-center">
                    ...
                    <div class="cont-header"> <img src="<?php echo e(WEBSITE_IMG_URL); ?>/signin.png" class="pr-1">
                        ...
                        <?php else: ?>
                    <a href="<?php echo e(route('client.login')); ?>" class="loginbtn"> Login/Signup as Client</a>
                        
                      <a href="<?php echo e(route('user.login')); ?>" class="loginbtn"> Login/Signup as Nanny</a>
                    ...
                    <nav class="navbar navbar-expand-lg">
                        ...
                        <div class="collapse navbar-collapse">
                            <ul class="navbar-nav ml-auto">
                                ...
                                <li class="nav-item active">
                                    <a class="nav-link" href="<?php echo e(route('user.blog')); ?>">Blog</a>
                                </li>
                                <?php /*
                                <li class="nav-item">
...
</header><?php /**PATH F:\xampp\htdocs\tinyhugs\resources\views/front/elements/header.blade.php ENDPATH**/ ?>