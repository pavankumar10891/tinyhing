...
<div class="content  d-flex flex-column flex-column-fluid" id="kt_content">
	...
	<div class="d-flex flex-column-fluid">
		<!--begin::Container-->
		<div class=" container ">
			<?php echo e(Form::open(['method' => 'get','role' => 'form','url' => 'adminpnlx/news-letter/newsletter-templates','class' => 'kt-form kt-form--fit mb-0','autocomplete'=>"off"])); ?>
					...
					<div class="card card-custom card-stretch card-shadowless">
						<div class="card-header">
							...
							<div class="card-toolbar">
								...
								<a href="<?php echo e(URL::to('adminpnlx/news-letter/add-template')); ?>" class="btn btn-primary"> <?php echo e(trans("Add Template ")); ?> </a>&nbsp;&nbsp;

								<a href="<?php echo e(URL::to('adminpnlx/news-letter/subscriber-list')); ?>" class="btn btn-primary"> <?php echo e(trans("Subscriber List ")); ?> </a>&nbsp;&nbsp;

								<a href="<?php echo e(URL::to('adminpnlx/news-letter')); ?>" class="btn btn-primary"> <?php echo e(trans("Scheduled Newletter ")); ?> </a>
									...
									<div>
											...
											<div class="row mt-8">
												<div class="col-lg-12">
													...
													<a href="<?php echo e(URL::to('adminpnlx/news-letter/newsletter-templates')); ?>" class="btn btn-secondary btn-secondary--icon">
														<span>
									...
									<table
										...
										<thead>
											<tr class="text-uppercase">
												...
												<th class="<?php echo e((($sortBy == 'updated_at' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'updated_at' && $order == 'asc') ? 'sorting_asc' : 'sorting'))); ?>">
													<?php echo e(link_to_route(
															'NewsTemplates.newsletterTemplates',
															trans("Updated On"),
															array(
												...
												<?php $__currentLoopData = $results; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $record): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
													<tr>
														...
														<td class="text-right pr-2">
															<a href="<?php echo e(URL::to('adminpnlx/news-letter/edit-newsletter-templates/'.$record->id)); ?>"
															...
															<a href="<?php echo e(URL::to('adminpnlx/news-letter/send-newsletter-templates/'.$record->id)); ?>"
																class="btn btn-icon btn-light btn-hover-primary btn-sm"
																data-toggle="tooltip" data-placement="top"
																data-container="body" data-boundary="window" title=""
...
<?php echo $__env->make('admin.layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp\htdocs\tinyhugs\resources\views/admin/newsletter/newsletter_templates.blade.php ENDPATH**/ ?>