									...
									<table
										...
										<thead>
                                            <tr class="text-uppercase">
                                                ...
                                                <th class="<?php echo e((($sortBy == 'no_of_month' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'no_of_month' && $order == 'asc') ? 'sorting_asc' : 'sorting'))); ?>">
                                                    <?php echo e(link_to_route(
                                                            "$modelName.index",
                                                            trans("Number Of Month"),
                                                            array(
                                                            'sortBy' => 'no_of_month',
                                                            'order' => ($sortBy == 'no_of_month' && $order == 'desc') ? 'asc' : 'desc',
                                                            $query_string
                                                            )
                                                        )); ?>

                                                </th>
                                                <th class="<?php echo e((($sortBy == 'order_type' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'order_type' && $order == 'asc') ? 'sorting_asc' : 'sorting'))); ?>">
                                                    <?php echo e(link_to_route(
                                                            "$modelName.index",
                                                            trans("Order"),
                                                            array(
                                                            'sortBy' => 'order_type',
                                                            'order' => ($sortBy == 'order_type' && $order == 'desc') ? 'asc' : 'desc',
                                                            $query_string
                                                            )
                                                        )); ?>
													...
													<tr>	
														<td>
															<div class="text-dark-75 mb-1 font-size-lg">
																<?php echo e(ucfirst($result->name)); ?>
														...
														<td>
															<div class="text-dark-75 mb-1 font-size-lg">
																<?php echo e($result->no_of_month); ?>

															</div>
														</td>
														<td>
															<div class="text-dark-75 mb-1 font-size-lg">
																<?php echo e($result->order_type); ?>
...
<?php echo $__env->make('admin.layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp\htdocs\tinyhugs\resources\views/admin/Package/index.blade.php ENDPATH**/ ?>