...
<script>
    ...
    $("#feedbackForm").on('submit',function(e){
        ...
        $.ajax({
         ...
         url: '<?php echo e(route("user.nannyGiveFeedback")); ?>',
         data: formData,
         type: "POST",
         contentType: false,
         cache: false,
    ...
    function showMore($elem) {
        ...
        $.ajax({
            ...
            url: '<?php echo e(route("user.nannyRatingList")); ?>',
            data: {'offset': offset},
            type: "POST",
            success: function(res) {
                if (res.data != '') {
...
<?php echo $__env->make('front.dashboard.layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp\htdocs\tinyhugs\resources\views/front/dashboard/nanny_rating.blade.php ENDPATH**/ ?>