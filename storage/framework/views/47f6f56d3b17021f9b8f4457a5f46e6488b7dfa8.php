    ...
    <div class="container">
        ...
        <div class="dashboard-profile">
                ...
                <div class="form-bx upload-resume form-group col-md-6">
                    <div class="d-md-inline-flex">
                        <input class="form-control referral_code" type="text" placeholder="Referral Code"
                            ...
                            id="referral_code">
                        <?php if($user_data->referral_code): ?>
            ...
            <div class="dashboard-block">
                ...
                <?php echo e(Form::open(array('id' => 'nanny-edit-form', 'class' => 'form', 'files' => true,'enctype'=> 'multipart/form-data'))); ?>
                    ...
                    <div class="row align-items-center">
                        <div class="col-auto">
                            <div class="img-wall1">
                                ...
                                <?php if(!empty($user_data->cpr_certificate)): ?>
                        ...
                        <div class="col-md-6">
                            <div class="form-group input-form mw-100">
                                ...
                                <span id="cpr_certificate_error" class="help-inline error"></span>
                                    <?php if($user_data->cpr_certificate != ""): ?>
                                        <a href="<?php echo e($cpr_certificate); ?>" download target="_blank"><i class="fa fa-download" aria-hidden="true"></i></a>
                                    <?php endif; ?>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group input-form mw-100">
                                ...
                                <?php if($user_data->other_certificates != ""): ?>
                                    <a href="<?php echo e($cpr_certificate); ?>" download target="_blank"><i class="fa fa-download" aria-hidden="true"></i></a>
                                <?php endif; ?>   
                    ...
                    <div class="upload-resume">
                        <div class="d-block d-xl-flex no-gutters">
                            <div class="form-group col-md-6">
                                ...
                                <?php if($user_data->resume != ""): ?>
                                    <a href="<?php echo e($resume); ?>" download target="_blank"><i class="fa fa-download" aria-hidden="true"></i></a>
                                    <?php endif; ?>
                            </div>
                    ...
                    <div class="custom-radio mr-md-2">    <input class="identification_type" type="radio" name="identification_type" value="1" id="identification_type_passport" <?php echo e(($user_data->identification_type == 1) ? 'checked':''); ?>> <label for="identification_type_passport">Passport  </label></div>
                    <div class="custom-radio">     <input class="identification_type" type="radio" name="identification_type" value="2" id="identification_type_license" <?php echo e(($user_data->identification_type == 2) ? 'checked':''); ?>> <label for="identification_type_license">Driving License </label></div>
                    ...
                    <div class="form-group d-inline-flex col-md-6">
                        ...
                        <?php if($user_data->identification_file != ""): ?>
                                        <a href="<?php echo e(CERTIFICATES_AND_FILES_URL.$user_data->identification_file); ?>" class="download-img" download="<?php echo e($user_data->identification_file); ?>" title="Click To Download">
                                            <img src="<?php echo e(WEBSITE_IMG_URL.'download.png'); ?>" width="30px" height="">
                                        </a>
                                    <?php endif; ?>
                    </div>
                  </div>
            ...
            <div class="dashboard-block">
                ...
                <div class="form-bx">
                    ...
                    <div class="pass-block">
                        <div class="form-group input-form mw-100">
                            <?php echo e(Form::password('old_password', ['class' => 'form-control ', 'placeholder' => 'Old
                            Password'])); ?>

                            <span id="old_password_error" class="help-inline error"></span>
                        </div>
                        <div class="form-group input-form mw-100">
                            <?php echo e(Form::password('new_password', ['class' => 'form-control', 'placeholder' => 'New
                            Password'])); ?>
                        ...
                        <div class="form-group input-form mb-1 mw-100">
                            <?php echo e(Form::password('new_password_confirmation', ['class' => 'form-control', 'placeholder' =>
                            'Confirm Password'])); ?>
...
<?php echo $__env->make('front.dashboard.layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp\htdocs\tinyhugs\resources\views/front/dashboard/nanny_profile.blade.php ENDPATH**/ ?>