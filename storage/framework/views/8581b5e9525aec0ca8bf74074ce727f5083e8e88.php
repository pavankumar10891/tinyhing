...
<div class="sidebar ">
            <div class="items py-md-5 ">
                <ul>
                    ...
                    <li class="<?php echo e(($segment == 'notification-nanny'  )? 'active': ''); ?>">
                    ...
                    <li class="<?php echo e(($segment == 'inbox-nanny'  )? 'active': ''); ?>">
                    ...
                    <li  class="<?php echo e(($segment == 'my-booking-nanny'  )? 'active': ''); ?>">
                    ...
                    <li class="<?php echo e(($segment == 'my-earning-nanny'  )? 'active': ''); ?>">
                    ...
                    <li class="<?php echo e(($segment == 'ratings-nanny'  )? 'active': ''); ?>">
                    ...
                    <li class="<?php echo e(($segment == 'interviews-nanny'  )? 'active': ''); ?>">
                    ...
                    <li class="<?php echo e(($segment == 'nanny-payment-setting'  )? 'active': ''); ?>">
                        <a href="<?php echo e(route('user.nanny-payment-setting')); ?>">
                            <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="pen-square"
                                role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"
                                class="svg-inline--fa fa-pen-square fa-w-14 fa-2x">
                                <path fill="currentColor"
        ...
        </div><?php /**PATH F:\xampp\htdocs\tinyhugs\resources\views/front/dashboard/elements/nanny_sidebar.blade.php ENDPATH**/ ?>