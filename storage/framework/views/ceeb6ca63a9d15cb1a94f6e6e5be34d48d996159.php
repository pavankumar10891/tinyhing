        ...
        <div class="container">
            <div class="total-client">
                <div class="client-block">
                    <div class="dashboard-heading-head">Notification</div>
                </div>
                ...
                <div class="notification_box">
                    ...
                    <?php if($results->isNotEmpty()): ?>
                        ...
                        <li data-id="<?php echo e($result->id); ?>">
                            <a href="javascript:void(0);" class="<?php echo e(($result->read_status==0?'unread':'')); ?>">
                                <div class="notiwall">
                                    <?php if($result->read_status==0): ?>
                                ...
                                <p class="notidesc"><?php echo e($result->message); ?>
...
function showMore($elem){
        $elem.hide();
 		...
 		$.ajax({
 			...
 			url: '<?php echo e(route("user.clientNotificationList")); ?>',
 			data: {
 				'offset': offset
 			},
 			type: "POST",
...
<?php echo $__env->make('front.dashboard.layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp\htdocs\tinyhugs\resources\views/front/dashboard/client_notification.blade.php ENDPATH**/ ?>