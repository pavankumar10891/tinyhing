...
<html lang="en">
	<head>
		...
		<link href="{{WEBSITE_CSS_URL}}front/style.css" rel="stylesheet">
...
<body class="over-hidden nofound-body">
	...
	<div id="mws-error-page" class="error-page text-center">
		...
		<div class="mail"><label>Email : </label><a href="mailto:{{ Config::get('Contact.email') }}">{{ Config::get('Contact.email') }}</a></div>
		...
		<a href="{{ URL::to('/') }}" class="btn backHome"><span>Back to the Homepage</span></a>
	</div>
