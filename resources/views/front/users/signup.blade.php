          ...
          <div class="row align-items-center">
            <div class="col-auto">
              ...
              @if(isset($image) && !empty($image))
                  <img id="previewImg" src="{{$image}}" class="img-fluid"> 
              @else 
                <img id="previewImg" src="{{WEBSITE_IMG_URL}}signup-profile.PNG" class="img-fluid"> 
              @endif
            ...
            <div class="d-block d-lg-flex no-gutters">
              ...
              <div class="d-block d-lg-flex no-gutters">
                  <div class="form-group input-form col-md-6" style="margin:0px 38px 19px 0">
                      <label>Name</label><br>
                        <div class="d-md-inline-flex">
                          <input class="form-control" type="text" placeholder="Name" name="name" value="{{ isset($name) ? $name:'' }}">
                        </div>
                        <br>
                  ...
                  <div class="form-group input-form col-md-6" style="margin:0px 38px 19px 0">
                      ...
                      <div class="d-md-inline-flex">
                        <input type="hidden" name="provider" value="{{ isset($provider) ? $provider:'' }}">
                        <input type="hidden" name="provider_id" value="{{ isset($provider_id) ? $provider_id:'' }}">
                        <input type="hidden" name="user_image" value="{{ isset($image) ? $image:'' }}">
                        <input class="form-control" type="text" placeholder="Email" name="email" value="{{ isset($email) ? $email:'' }}">
                        <!-- <label for="profile_pic2"> <a class="btn-theme text-white">Upload</a> </label> -->
