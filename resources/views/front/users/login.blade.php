            ...
            <div class="row pb-md-5 pb-3 flex-row">
                <div class="col">
                    ...
                    <div class="col-md-auto">
                       <div class="create-account"> Not a member? <a href="{{ route('user.signup') }}" style="color: #ffd500;">Sign up   </a></div>
                    </div>
            </div>
            <div class="form-bx">
   
             <div class="social-login ">
                 <a href="{{ url('/login/nanny/google') }}" class="g-login">
                    <img src="{{WEBSITE_IMG_URL}}google-icon.jpg">  Login with Google
                </a>
                <a href="{{ url('/login/nanny/facebook') }}" class="fb-login">
