            ...
            <div class="row align-items-center py-2">
                <div class="col-md-12 text-md-right text-center">
                    <div class="cont-header pr-3"> CALL FREE ON :<a href="javascript:void"> 
                        {{ Config::get('Site.free_call') }} </a></div>
                        @if(Auth::check())
                        <div class="cont-header pr-2"> <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="tachometer-alt-fastest" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" class="svg-inline--fa fa-tachometer-alt-fastest fa-w-18 fa-2x">
                            ...
                            </svg><a href="{{ route('user.nannydashboard') }}">DASHBOARD</a></div>    @endif  
                    <div class="cont-header"> <img src="{{ WEBSITE_IMG_URL  }}/signin.png" class="pr-1">
                        @if(Auth::check())
                        {{-- <div class="dropdown open show">
                        <button class="btn dropdown-toggle site_btn" type="button" id="dropdownProfileButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                            User
                        </button> 
                        <ul class="dropdown-menu profile_dropdown show" aria-labelledby="dropdownProfileButton">--}}
                    ...
                    --}}
                        ...
                        @else
                    <a href="{{ route('client.login') }}" class="loginbtn"> Login/Signup as Client</a>
                        
                      <a href="{{ route('user.login')}}" class="loginbtn"> Login/Signup as Nanny</a>
                       {{--<a href="{{ route('user.signup')}}" class="loginbtn"> Signup as Babysitter</a>--}}
                    ...
                    <nav class="navbar navbar-expand-lg">
                        ...
                        <div class="collapse navbar-collapse">
                            <ul class="navbar-nav ml-auto">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('user.nannylist') }}">Our Nannies</a>
                                </li>
                                <li class="nav-item active">
                                    <a class="nav-link" href="{{ route('user.pricing') }}">Pricing</a>
                                </li>
                                <li class="nav-item active">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('user.faqs') }}">FAQs</a>
                                </li>
                                <li class="nav-item">
                            ...
                            <div class="extra_nav author-detail">
                               <div class="d-flex align-items-center nav-right pl-3">
                                   ...
                                   <div class="author-name text-left pl-3">
                                            <a href="#">{{ (!empty($userData->name) ?  $userData->name  :  '' )  }}</a>
                                           <!-- <span> Customer</span>  -->
                                        </div>
                                    </div>
                                </div>
