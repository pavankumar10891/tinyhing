                            ...
                            <div class="stars">
                                <strong>
                                    @if(!empty($totalRatingCount))
                                            {{ round(($totalRating / $totalRatingCount), 1) }}
                                            <span class="satrimg">
                                ...
                                <span class="text"> ({{ ($totalRatingCount > 0) ? $totalRatingCount:'0'}} Reviews)</span>
                            </div>
                            <p>
                                    ...
                                    <div class="row">
                                        <div class="col-md-auto col-xl-4">
                                           ...
                                           <span>New Member</span>
                                            ...
                                            @endif</strong>
                                                ...
                                                <span class="text">Based on {{ ($totalRatingCount > 0) ? $totalRatingCount:'0'}} Reviews</span>
                                            </div>
                                        </div>
                                        <div class="col">
                                           ...
                                           <div class="progress-heading"> excellent</div>
                                            <div class="progress">
                                                ...
                                                <div class="progress-bar bg-success" role="progressbar"
                                                 style="width: {{$excellentRatingCount}}%" aria-valuenow="{{$excellentRatingCount}}" aria-valuemin="0" aria-valuemax="100"></div>
                                              </div>
                                        </div>
                                        ...
                                        <div class="progress-heading"> Good</div>
                                            <div class="progress">
                                                ...
                                                <div class="progress-bar bg-green" role="progressbar" style="width: {{$goodRatingCount}}%" aria-valuenow="{{$goodRatingCount}}" aria-valuemin="0" aria-valuemax="100"></div>
                                        ...
                                        <div class="progress">
                                                ...
                                                <div class="progress-bar bg-warning" role="progressbar" style="width: {{$averageRatingCount}}%" aria-valuenow="{{$averageRatingCount}}" aria-valuemin="0" aria-valuemax="100"></div>
                                        ...
                                        <div class="progress-block">
                                            ...
                                            <div class="progress">
                                                ...
                                                <div class="progress-bar bg-orange" role="progressbar" style="width: {{$belowaverageRatingCount}}%" aria-valuenow="{{$belowaverageRatingCount}}" aria-valuemin="0" aria-valuemax="100"></div>
                                              </div>    </div>
                                              ...
                                              <div class="progress">
                                               <div class="progress-bar bg-red" role="progressbar" style="width: {{$poorRatingCount}}%" aria-valuenow="{{$poorRatingCount}}" aria-valuemin="0" aria-valuemax="100"></div>
                                                 </div>
                                              </div>   
                                            </div>
                                        </div>
                      ...
                      <div class="review-block">
                        <div class="rating-block-heading pt-5">Ratings</div>
                                        ...
                                        <div class="card-horizontal no-gutters">
                                            <div class="col-auto">
                                                <div class="img-wall1">
                                                    @if(!empty(file_exists(USER_IMAGE_ROOT_PATH.$result->photo_id)))
                                                    <img src="{{ WEBSITE_URL.'image.php?width=47&height=47&cropratio=3:3&image='.USER_IMAGE_URL.$result->photo_id }}" alt="">
                                                    @else
                                                    <img src="{{WEBSITE_IMG_URL}}profile-2.png" class="img-fluid">
                                                    @endif

                                                </div>
                                                <h4 class="card-title">{{!empty($result->name) ? $result->name:''}}</h4>
                                                <span>
                                            ...
                                            <div class="col pl-lg-3">
                                                    ...
                                                    {{!empty($result->created_at) ? date('m/d/Y h:i a',strtotime($result->created_at)):''}}
                                                     
                                                       
                                                    </div>
                                              
                                                <p class="card-text">
                                                   {!! !empty($result->review) ? $result->review:'' !!}</p>
                                            </div>
                                        </div>
                                        @endforeach
                                        <!-- <div class="card-horizontal no-gutters">
