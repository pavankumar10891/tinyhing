				...
				<form action="" id="sor_by_form" method="get" >
					...
					<div  style="float:right">
						<select name="nanny_type" class="form-control">
							...
							<option value="2" {{ isset($_REQUEST['type']) &&  $_REQUEST['type'] == 'babbysitter' ? 'selected':'' }}>Babbysitter</option>
							<option value="3" {{ isset($_REQUEST['type']) &&  $_REQUEST['type'] == 'both' ? 'selected':'' }}>Both</option>
						</select>
						</div>
				</form>
			</div>
