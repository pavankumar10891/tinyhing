                ...
                <div class="col-lg-8 col-md-7 col-sm-12 col-xs-12">
                    <div class="single-blog">
                        <div class="blog-image">
                            <img src="{{ BLOG_IMAGE_URL.$blog->banner_image }}" alt="">
                        </div>
                    ...
                    <div class="share-button">
                        ...
                        <div class="social-bookmark">
                            <ul class="list-unstyled social_link_bar ">
                                ...
                                <li>
                                <a class="twitter-share-button twitter-bx" onclick="window.open('{{ $twitter_share_link }}','name','width=600,height=400')"  href="javascript:void(0)"  data-size="large">
                                 
                               <!-- <a href="javascript:void(0)" onclick="window.open('{{ $twitter_share_link }}','name','width=600,height=400')" class="twitter-bx">-->
