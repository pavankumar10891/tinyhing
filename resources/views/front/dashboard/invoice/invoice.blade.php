...
<div class="main-workspace">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td data-label="Action" class="text-right">
                                         @if($checkReview == 0)
                                        <a href="javascript:void(0);" class="btn btn-theme giveTip"  data-id="{{$value->nanny_id}}" data-name="{{$value->name}}">
                                            Send tip
                                        </a>
                                         @endif
                                        @if($checkReview == 0)
                                        <a href="javascript:void(0);" class="btn btn-theme giveRating" data-id="{{$value->nanny_id}}" data-name="{{$value->name}}">
                                            Give a Review
                                        </a>
                                        @endif
                                    </td>
	...
	<input id="rating-4" type="radio" name="rating" value="4" checked /><label for="rating-4"><i class="fas fa-2x fa-star"></i></label>
	...
	<input id="rating-1" type="radio" name="rating" value="1"/><label for="rating-1"><i class="fas fa-2x fa-star"></i></label>
        ...
        <div class="modal fade give-feedback enter-card-detail show pr-0" id="tipModel" tabindex="-1"
            aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                <div class="modal-header">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="floating-label">
                                                ...
                                                <br><br>
                                                <div class="btn-block text-center pb-3">
                                                {{ Form::button('Save', ['type' => 'button', 'class' => 'btn-theme', 'id' => 'tip-submit']) }}
    ...
    $("#siterating").on('click',function(e){
       ...
       //values=  $("#feedbackFormTinyHug").serialize()
        ...
        $.ajax({
             ...
             url: '{{route("user.clientGiveFeedbacktinyhug.site")}}',
