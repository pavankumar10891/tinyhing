...
<div class="dashboard-profile">
    <div class="dashboard-block">
        <div class="row pb-4 flex-row">
            ...
            {{ Form::open(array('id' => 'nanny-edit-form', 'class' => 'form')) }}
                <div class="row align-items-center">
                    <div class="col-auto">
                        ...
                        @if($user_data->provider == 'google' || $user_data->provider == 'facebook' && $user_data->photo_id != '')
                        <img id="previewImg" src="{{ $user_data->photo_id }}" class="img-fluid">
                        @else
                       <img  id="previewImg"  class="img-fluid" src="{{ WEBSITE_URL.'image.php?width=47&height=47&cropratio=3:3&image='.CERTIFICATES_AND_FILES_URL.$user_data->photo_id }}" alt="">
                        @endif   
                    
                        @else
                        <img  id="previewImg" class="img-fluid"  src="{{ WEBSITE_URL.'image.php?width=47&height=47&cropratio=3:3&image='.WEBSITE_IMG_URL.'profile-img1.jpg' }}" alt="">
                        @endif
