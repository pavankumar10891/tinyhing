...
<div class="items py-md-5 ">
    <ul>
        <li class="{{  ($segment == 'dashboard'  )? 'active': '' }}">
            <a href="{{ route('user.nannydashboard') }}">
        ...
        <li class="{{  ($segment == 'notification-client'  )? 'active': '' }}">
            <a href="{{ route('user.clientNotificationList') }}">
        ...
        <li class="{{  ($segment == 'inbox-client'  )? 'active': '' }}">
            <a href="{{ route('user.clientInboxList') }}">
        ...
        <li class="{{  ($segment == 'my-booking-client'  )? 'active': '' }}">
            <a href="{{ route('user.clientBookingList') }}">
        ...
        <li class="{{  ($segment == 'my-earning-client'  )? 'active': '' }}">
            <a href="{{ route('user.clientEarningList') }}">
        ...
        <li class="{{  ($segment == 'my-invoice'  )? 'active': '' }}">
        ...
        @endif
        <li class="{{  ($segment == 'ratings-client'  )? 'active': '' }}">
            <a href="{{ route('user.clientRatingList') }}">
        ...
        <li class="{{  ($segment == 'interviews-client'  )? 'active': '' }}">
            <a href="{{ route('user.clientInterviewList') }}">
        ...
        <li class="{{  ($segment == 'my-plan'  )? 'active': '' }}">
            <a href="{{ route('user.myPlanDetail') }}">
                <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="calendar-alt"
                    role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"
                    class="svg-inline--fa fa-calendar-alt fa-w-14 fa-2x">
                    <path fill="currentColor"
        ...
        <li  class="{{  ($segment == 'profile'  )? 'active': '' }}">
            <a href="{{ route('nanny.edit.profile') }}">
        ...
        <li class="{{  ($segment == 'payment-setting'  )? 'active': '' }}">

            <a href="{{route('user.payment-setting')}}">
        ...
        <li class="{{  ($segment == 'support-chat'  )? 'active': '' }}">
            <a href="{{URL::to('support-chat')}}">
        ...
        <li class="{{  ($segment == 'logout'  )? 'active': '' }}">
