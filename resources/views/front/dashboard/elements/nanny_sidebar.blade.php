...
<div class="sidebar ">
            <div class="items py-md-5 ">
                <ul>
                    ...
                    <li class="{{  ($segment == 'set-availability'  )? 'active': '' }}">
                         <a href="{{route('user.set.availability')}}">
                    ...
                    <li class="{{  ($segment == 'notification-nanny'  )? 'active': '' }}">
                        <a href="{{ route('user.nannyNotificationList') }}">
                    ...
                    <li class="{{  ($segment == 'inbox-nanny'  )? 'active': '' }}">
                        <a href="{{ route('user.nannyInboxList') }}">
                    ...
                    <li  class="{{  ($segment == 'my-booking-nanny'  )? 'active': '' }}">
                        <a href="{{ route('user.nannyBookingList') }}">
                    ...
                    <li class="{{  ($segment == 'my-earning-nanny'  )? 'active': '' }}">
                        <a href="{{ route('user.nannyEarningList') }}">
                    ...
                    <li class="{{  ($segment == 'ratings-nanny'  )? 'active': '' }}">
                        <a href="{{ route('user.nannyRatingList') }}">
                    ...
                    <li class="{{  ($segment == 'interviews-nanny'  )? 'active': '' }}">
                        <a href="{{ route('user.nannyInterviewList') }}">
                    ...
                    <li class="{{  ($segment == 'nanny-payment-setting'  )? 'active': '' }}">
                        <a href="{{route('user.nanny-payment-setting')}}">
                            <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="pen-square"
                                role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"
                                class="svg-inline--fa fa-pen-square fa-w-14 fa-2x">
                                <path fill="currentColor"
