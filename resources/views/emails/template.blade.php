          ...
          <tr>
            <td>
              <table width="100%" border="0" cellspacing="0" cellpadding="0"
                ...
                ?>
                  <td align="left" valign="middle" style="padding:5px 0px;  "><img src="{{ $logoimage }}" alt="logo"></td>
                  <td align="center" valign="middle" style="padding:5px 0px; ">
                    <a href="{{ WEBSITE_URL }}" target="_blank" style="color:#000040; font-size:18px; text-decoration:none; color:#fff; font-weight:bold; text-transform:uppercase;">{{ Config::get('Site.title') }}</a>
                  </td>
