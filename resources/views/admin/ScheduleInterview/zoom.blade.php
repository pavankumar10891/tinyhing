 ...
 <div class="container">
        ...
        var testTool = {
            ...
            getMeetingConfig: function () {
                return {
                    ...
                    name: testTool.b64EncodeUnicode("<?php echo Auth::guard('admin')->user()->name; ?>"),
                    pwd: "<?php echo $result->meeting_password; ?>",
                    role: parseInt(1, 10),
                    email: testTool.b64EncodeUnicode("<?php echo $result->host_email; ?>"),
                    lang: 'en-US',
                    signature: "",
                    china: 0,
                };
    ...
    function websdkready() {
        ...
        var meetingConfig = {
            ...
            return (
                testTool.b64DecodeUnicode(testTool.b64EncodeUnicode("<?php echo Auth::guard('admin')->user()->name; ?>"))
            );
            })(),
            passWord: "<?php echo $result->meeting_password; ?>",
            leaveUrl: "{{ route('ScheduleInterview.index') }}",
            role: parseInt(0, 10),
            userEmail: (function () {
            try {   
                return testTool.b64DecodeUnicode("<?php echo $result->host_email; ?>");
            } catch (e) {
                return '';
            }
            })(),
