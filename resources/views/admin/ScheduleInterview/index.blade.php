                                        ...
                                        <div class="row mb-6">
                                         <!--   <div class="col-lg-4 mb-lg-5 mb-6">
                                            ...
                                            <div class="col-lg-4 mb-lg-5 mb-6">
                                                ...
                                                {{ Form::text('nanny_name',((isset($searchVariable['nanny_name'])) ? $searchVariable['nanny_name'] : ''), ['class' => ' form-control','placeholder'=>'Nanny Name']) }}
                                            </div>
                                            <div class="col-lg-4 mb-lg-5 mb-6">
                                            ...
                                            <div class="col-lg-4 mb-lg-5 mb-6">
                                                ...
                                                <div class="input-group date" id="datepickerinterview"
                                                    ...
                                                    {{ Form::text('interview_date',((isset($searchVariable['interview_date'])) ? $searchVariable['interview_date'] : ''), ['class' => ' form-control datetimepicker-input','placeholder'=>'Interview Date','data-target'=>'#datepickerinterview','data-toggle'=>'datetimepicker']) }}
                                    ...
                                    <table
                                        ...
                                        <thead>
                                            <tr class="text-uppercase">
                                                <th
                                                    class="{{(($sortBy == 'nanny_name' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'nanny_name' && $order == 'asc') ? 'sorting_asc' : 'sorting'))}}">
                                                    {{
														link_to_route(
															"$modelName.index",
															trans("Nanny Name"),
                                                ...
                                                <th
                                                    class="{{(($sortBy == 'time_slot' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'time_slot' && $order == 'asc') ? 'sorting_asc' : 'sorting'))}}">
                                                    {{
														link_to_route(
															"$modelName.index",
															trans("Time Slot"),
                                                ...
                                                <th
                                                    class="{{(($sortBy == 'interview_date' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'interview_date' && $order == 'asc') ? 'sorting_asc' : 'sorting'))}}">
                                                    {{
														link_to_route(
															"$modelName.index",
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="text-dark-75 mb-1 font-size-lg">
                                                        {{ date(config::get("Reading.date_format"),strtotime($result->interview_date)) }}
                                                    </div>
                                                </td>
                                                <td>
                                                @if($result->is_interview == 1)
                                                <span class="label label-lg label-light-success label-inline">Approved</span>
                                                @elseif($result->is_interview == 2)
                                                <span class="label label-lg label-light-danger label-inline">Rejected</span>
                                                <p class="lable warning">Reason: {{ !empty($result->reject_reason) ? $result->reject_reason:'' }}</p>
                                                @else
                                                ...
                                                @if($result->is_interview == 1)
                                                    @if(strtotime($result->interview_date.$timeSlotData[1]) > $todayDate)
                                                        @if(strtotime($date1) > strtotime($date2))
                                                            <a class="btn btn-primary" href="{{ route('admin.meeting.join', $result->id) }}">Join Now</a>
                                                        @endif
                                                    @endif
                                                @endif
