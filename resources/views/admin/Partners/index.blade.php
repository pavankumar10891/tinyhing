													...
													<tr>	
													    <td>
															<div class="text-dark-75 mb-1 font-size-lg">
                                                                @if($result->logo != "")
																	<a class="fancybox-buttons" data-fancybox-group="button" href="{{PARTNER_LOGO_URL.$result->logo}}">
																		<img class="" src="{{PARTNER_LOGO_URL.$result->logo}}" width="50px" height="50px">
																	</a>
																@endif
															</div>
														</td>
