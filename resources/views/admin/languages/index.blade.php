...
<div class="content  d-flex flex-column flex-column-fluid" id="kt_content">
	...
	<div class="d-flex flex-column-fluid">
		<!--begin::Container-->	
		<div class=" container ">
			{{ Form::open(['method' => 'get','role' => 'form','route' => "LanguageSetting.index",'class' => 'kt-form kt-form--fit mb-0']) }}
			{{ Form::hidden('display') }}
			<div class="row">
				<div class="col-12">
									...
									<div>
											...
											<div class="row mt-8">
												<div class="col-lg-12">
													...
													<a href='{{URL::to('adminpnlx/language-settings')}}'  class="btn btn-secondary btn-secondary--icon">
														<span>
									...
									<table
										...
										<thead>
											<tr class="text-uppercase">
												...
												<th class="{{(($sortBy == 'msgstr' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'msgstr' && $order == 'asc') ? 'sorting_asc' : 'sorting'))}}">
													{{
														link_to_route(
															"LanguageSetting.index",
															trans("String"),
												...
												<th class="{{(($sortBy == 'locale' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'locale' && $order == 'asc') ? 'sorting_asc' : 'sorting'))}}">
													{{
														link_to_route(
															"LanguageSetting.index",
															trans("Language Code"),
												...
												@foreach($result as $results)
													<tr>
														...
														<td class="text-right pr-2">
															<a href='{{URL::to('adminpnlx/language-settings/edit-setting/'.$results->id)}}'
																class="edit_button btn btn-icon btn-light btn-hover-primary btn-sm"
																id="edit_<?php echo $results->id?>"
