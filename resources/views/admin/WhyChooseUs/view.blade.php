					...
					<div class="tab-content px-10">
						...
						<div class="tab-pane active" id="kt_apps_contacts_view_tab_1" role="tabpanel">
							...
							<div class="form-group row my-2">
								...
								<div class="col-8">
									<span class="form-control-plaintext font-weight-bolder">{{ isset($model->order_number) ? $model->order_number :'' }}</span>
								</div>
							</div>
							...
							<div class="form-group row my-2">
								...
								<div class="col-8">
                                    <span class="form-control-plaintext font-weight-bolder">
                                        @if($model->image != "")
                                            <a class="fancybox-buttons" data-fancybox-group="button" href="{{WHYCHOOSEUS_IMAGE_URL.$model->image}}">
												<img class="" src="{{WHYCHOOSEUS_IMAGE_URL.$model->image}}" width="50px" height="50px">
											</a>
                                        @endif
                                    </span>
                                </div>
