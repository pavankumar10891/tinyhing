                                    ...
                                    <div>
                                        <div class="row mb-6">
                                            ...
                                            <div class="col-lg-4 mb-lg-5 mb-6">
                                                <label>Price</label>
                                                {{ Form::text('price',((isset($searchVariable['price'])) ? $searchVariable['price'] : ''), ['class' => ' form-control','placeholder'=>'Price']) }}
                                            </div>
                                            <div class="col-lg-4 mb-lg-5 mb-6">
                                                <label>Country</label><br>
                                                {{ Form::select('country_id',array(''=>trans('Select Country'))+$countries,((isset($searchVariable['country_id'])) ? $searchVariable['country_id'] : ''), ['class' => 'form-control chosenselect']) }}
                                            </div>
                                    ...
                                    <table
                                        ...
                                        <thead>
                                            <tr class="text-uppercase">
                                                <th
                                                    class="{{(($sortBy == 'country_name' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'country_name' && $order == 'asc') ? 'sorting_asc' : 'sorting'))}}">
                                                    {{
														link_to_route(
															"$modelName.index",
															trans("Country"),
                                                ...
                                                <th
                                                    class="{{(($sortBy == 'city' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'city' && $order == 'asc') ? 'sorting_asc' : 'sorting'))}}">
                                                    {{
														link_to_route(
															"$modelName.index",
															trans("City"),
                                                ...
                                                <th
                                                    class="{{(($sortBy == 'tax' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'tax' && $order == 'asc') ? 'sorting_asc' : 'sorting'))}}">
                                                    {{
														link_to_route(
															"$modelName.index",
															trans("Tax(%)"),
