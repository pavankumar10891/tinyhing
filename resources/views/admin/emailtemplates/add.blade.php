...
<div class="content  d-flex flex-column flex-column-fluid" id="kt_content">
	...
	<div class="d-flex flex-column-fluid">
		<!--begin::Container-->
		<div class=" container ">
			{{ Form::open(['role' => 'form','url' => 'adminpnlx/email-manager/add-template','class' => 'mws-form']) }}
											...
											<div class="row">
												<div class="col-xl-6">
													...
													<div class="form-group">
														@if($i == 1)
															...
															{{ Form::text("data[$language->id][name]","", ['class' => 'form-control form-control-solid form-control-lg '.($errors->has('name') ? 'is-invalid':'')]) }}
															<div class="invalid-feedback"><?php echo ($i ==  $language_code ) ? $errors->first('name') : ''; ?></div>
															
														@else
															{!! HTML::decode( Form::label($language->id.'.name',trans("Name").'<span class="text-danger">  </span>')) !!}
															{{ Form::text("data[$language->id][name]","", ['class' => 'form-control form-control-solid form-control-lg ']) }}
														@endif
													</div>
													<!--end::Input-->
												</div>
												...
												<div class="col-xl-6">
													...
													<div class="form-group">
														@if($i == 1)
															...
															{{ Form::text("data[$language->id][subject]","", ['class' => 'form-control form-control-solid form-control-lg '.($errors->has('subject') ? 'is-invalid':'')]) }}
															<div class="invalid-feedback"><?php echo ($i ==  $language_code ) ? $errors->first('subject') : ''; ?></div>
															
														@else
															{!! HTML::decode( Form::label($language->id.'.subject',trans("Subject").'<span class="text-danger">  </span>')) !!}
															{{ Form::text("data[$language->id][subject]","", ['class' => 'form-control form-control-solid form-control-lg ']) }}
														@endif
													</div>
													<!--end::Input-->
												</div>
												...
												<div class="col-xl-6">
													<div class="form-group">
														...
														<a onclick = "return InsertHTML({{$i}})" href="javascript:void(0)" class="btn  btn-success no-ajax pull-right"><i class="icon-white "></i>{{  trans("Insert Variable") }} </a>
													</div>
												...
												<div class="col-xl-12">
													...
													<div class="form-group">
														...
														@if($i == 1)
															...
															{{ Form::textarea("data[$language->id][body]","", ['class' => 'form-control form-control-solid form-control-lg '.($errors->has('body') ? 'is-invalid':''),'id' => 'body']) }}
															<div class="invalid-feedback"><?php echo ($i ==  $language_code ) ? $errors->first('body') : ''; ?></div>
															
														@else
															{!! HTML::decode( Form::label($language->id.'.body',trans("Email Body").'<span class="text-danger">  </span>')) !!}
															{{ Form::textarea("data[$language->id][body]","", ['class' => 'form-control form-control-solid form-control-lg','id' => 'body']) }}
														@endif
													</div>
													<script>
