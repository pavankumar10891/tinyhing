                            ...
                            <div class="row">
                                <div class="col-xl-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        {{ Form::text('name',(!empty($model->name)?$model->name:''), ['class' => 'form-control form-control-solid form-control-lg '.($errors->has('name') ? 'is-invalid':'')]) }}
                                ...
                                <div class="col-xl-6">
                                    ...
                                    <div class="form-group">
                                        {!! HTML::decode( Form::label('designation', trans("Designation").'<span
                                            class="text-danger"> * </span>')) !!}
                                        {{ Form::text('designation',(!empty($model->designation)?$model->designation:''), ['class' => 'form-control form-control-solid form-control-lg '.($errors->has('designation') ? 'is-invalid':'')]) }}
