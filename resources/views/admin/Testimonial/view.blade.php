					...
					<div class="tab-content px-10">
						...
						<div class="form-group row my-2">
							...
							<div class="form-group row my-2">
								...
								<div class="col-8">
									<span class="form-control-plaintext font-weight-bolder">{{ isset($model->name) ? ucfirst($model->name) :'' }}</span>
								</div>
							</div>
							...
							<div class="form-group row my-2">
								...
								<div class="col-8">
									<span class="form-control-plaintext font-weight-bolder">{{ isset($model->designation) ? $model->designation :'' }}</span>
								</div>
							</div>
