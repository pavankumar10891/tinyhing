                            ...
                            <div class="row">
                            	<div class="col-md-6">	
									...
									<div class="form-group">
										{{ Form::label('category_id',trans("Blog Category"), ['class' => 'mws-form-label']) }}<span class="text-danger"> * </span>
											...
											{{ Form::select('category_id',$blogCategory,$model->category_id,['class' => 'form-control','placeholder'=>'Choose Blog Category']) }}
                                ...
                                <div class="col-xl-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        {{ Form::text('title',isset($model->title) ? $model->title : '', ['class' => 'form-control form-control-solid form-control-lg '.($errors->has('title') ? 'is-invalid':'')]) }}
                                ...
                                <div class="col-xl-6">
                                    ...
                                    <div class="form-group">
                                        {!! HTML::decode( Form::label('posted_by', trans("Posted By").'<span
                                            class="text-danger"> * </span>')) !!}
                                        {{ Form::text('posted_by',isset($model->posted_by) ? $model->posted_by : '', ['class' => 'form-control form-control-solid form-control-lg '.($errors->has('posted_by') ? 'is-invalid':'')]) }}
										...
										<div class="form-group embedded_image <?php echo ($errors->first('banner_image')) ? 'has-error' : ''; ?>">
											...
											<div class="mws-form-item">
												...
												<?php 
												   ...
												   $oldImage = '';
													$image		=	isset($oldImage) ? $oldImage : $model->banner_image;
												?>
												@if($model->banner_image != '')
													<a class="fancybox-buttons" data-fancybox-group="button" href="{{ BLOG_IMAGE_URL.$model->banner_image }}">
														<div class="usermgmt_image">
															<img  src="{{ BLOG_IMAGE_URL.$model->banner_image }}" width="100" height="50">
														</div>
													</a>
												@else
													<a class="fancybox-buttons" data-fancybox-group="button" width="150px" height="150px" href="<?php echo WEBSITE_IMG_URL ?>no-image.png">
														<div class="usermgmt_image">
															<img class="img-circle" width="150px" height="150px" src="<?php echo WEBSITE_IMG_URL ?>no-image.png">
														</div>
													</a>
												@endif
											</div>
									...
									<div class="col-xl-12">
										...
										<div class="form-group">
											<div id="kt-ckeditor-1-toolbar"></div>
												...
												{{ Form::textarea("description",isset($model->description) ? $model->description : '', ['class' => 'form-control form-control-solid form-control-lg','id' => 'Description']) }}
										</div>
										<script>
