...
<div class="content  d-flex flex-column flex-column-fluid" id="kt_content">
	...
	<div class="d-flex flex-column-fluid">
        <!--begin::Container-->
        <div class=" container ">
            {{ Form::open(['method' => 'get','role' => 'form','route' => "$modelName.listBlog",'class' => 'kt-form kt-form--fit mb-0','autocomplete'=>"off"]) }}
            {{ Form::hidden('display') }}
            <div class="row">
                <div class="col-12">
                                    ...
                                    <div>
                                        ...
                                        <div class="row mt-8">
                                            <div class="col-lg-12">
                                                ...
                                                <a href='{{ route("$modelName.listBlog")}}'
                                    ...
                                    <table
                                        ...
                                        <thead>
                                            <tr class="text-uppercase">
                                            	<th  class="{{(($sortBy == 'posted_by' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'posted_by' && $order == 'asc') ? 'sorting_asc' : 'sorting'))}}">
													{{
														link_to_route(
														"$modelName.listBlog",
														trans("Posted By"),
