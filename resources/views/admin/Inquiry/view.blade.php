					...
					<div class="tab-content px-10">
						...
						<div class="tab-pane active" id="kt_apps_contacts_view_tab_1" role="tabpanel">
							...
							<div class="form-group row my-2">
								...
								<div class="col-8">
									<span class="form-control-plaintext font-weight-bolder">{{ isset($model->subject) ? $model->subject :'' }}</span>
								</div>
							</div>
							<div class="form-group row my-2">
								<label class="col-4 col-form-label">Message:</label>
								<div class="col-8">
									<span class="form-control-plaintext font-weight-bolder">{!! isset($model->message) ? $model->message :'' !!}</span>
								</div>
							</div>
							<div class="form-group row my-2">
