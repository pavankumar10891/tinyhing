                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-10">
                            <h3 class="mb-10 font-weight-bold text-dark">
                                Edit {{ $sectionNameSingular }} Information</h3>

                            <div class="row">
                                <div class="col-xl-6">
                                    <!--begin::Input-->
                                    <div class="form-group">
                                        {!! HTML::decode( Form::label('coupon_code', trans("Coupon Code").'<span class="text-danger">
                                            * </span>')) !!}
                                        {{ Form::text('coupon_code', isset($model->coupon_code) ? $model->coupon_code : '', ['class' => 'form-control form-control-solid form-control-lg '.($errors->has('coupon_code') ? 'is-invalid':'')]) }}
                                ...
                                <div class="col-xl-6">
                                    ...
                                    <div class="form-group">
                                        {!! HTML::decode( Form::label('start_date', trans("Coupon Valid From").'<span
                                            ...
                                            {{ Form::text('start_date',isset($model->start_date) ? $model->start_date : '', ['class' => 'form-control form-control-solid form-control-lg datetimepicker-input '.($errors->has('start_date') ? 'is-invalid':''),'placeholder'=>'Valid From','data-target'=>'#datepickerfrom','data-toggle'=>'datetimepicker']) }}
                                ...
                                <div class="col-xl-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group date" id="datepickerto" data-target-input="nearest">
                                            {{ Form::text('end_date',isset($model->end_date) ? $model->end_date : '',['class' => 'form-control form-control-solid form-control-lg datetimepicker-input '.($errors->has('end_date') ? 'is-invalid':''),'placeholder'=>'Valid To','data-target'=>'#datepickerto','data-toggle'=>'datetimepicker']) }}
                                            <div class="input-group-append">
                                                <span class="input-group-text">
                                                    <i class="ki ki-calendar"></i>
                                                </span>
                                ...
                                <div class="col-xl-6">
                                    ...
                                    <div class="form-group">
                                        {!! HTML::decode( Form::label('amount', trans("Amount").'<span
                                            class="text-danger"> * </span>')) !!}
                                        {{ Form::text('amount', isset($model->amount) ? $model->amount : '', ['class' => 'form-control form-control-solid form-control-lg '.($errors->has('amount') ? 'is-invalid':'')]) }}
                                        ...
                                        {!! HTML::decode( Form::label('coupon_type', trans("Coupon Type").'<span
                                            ...
                                            @if(!empty($couponTypeArr))
                                                @foreach($couponTypeArr as $couponKey => $couponVal)
                                                    {{ Form::radio('coupon_type',$couponKey,(!empty($model->coupon_type) && $model->coupon_type == $couponKey) ? true : false,['class'=>'' .($errors->has('coupon_type') ? 'is-invalid':''), 'id' => "coupon_".$couponKey]) }}
