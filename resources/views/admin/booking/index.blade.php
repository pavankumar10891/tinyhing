                    ...
                    <div class="card card-custom card-stretch card-shadowless">
                        <div class="card-header">
                            ...
                            <div class="card-toolbar">
                               ...
                               {{-- <a href='{{route("$modelName.add")}}' class="btn btn-primary">
                                    ...
                                    <div>
                                        <div class="row mb-6">
                                            <div class="col-lg-4 mb-lg-5 mb-6">
                                                <label>Status</label>
                                                {{ Form::select('is_active',array(''=>trans('All'),0=>trans('Pending'),1=>trans('Accepted'), 2 => trans('Stopped'), 3=>trans('Rejected')),((isset($searchVariable['is_active'])) ? $searchVariable['is_active'] : ''), ['class' => 'form-control select2init']) }}
                                            </div>
                                            <div class="col-lg-4 mb-lg-5 mb-6">
                                                <label>Nanny</label>
                                                {{ Form::text('nanny',((isset($searchVariable['nanny'])) ? $searchVariable['nanny'] : ''), ['class' => ' form-control','placeholder'=>'Nanny']) }}
                                            </div>
                                            <div class="col-lg-4 mb-lg-5 mb-6">
                                                <label>Customer</label>
                                                {{ Form::text('customer',((isset($searchVariable['customer'])) ? $searchVariable['customer'] : ''), ['class' => ' form-control','placeholder'=>'Customer']) }}
                                            </div>
                                    ...
                                    <table
                                        ...
                                        <thead>
                                            <tr class="text-uppercase">
                                                <th
                                                    class="{{(($sortBy == 'customer' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'customer' && $order == 'asc') ? 'sorting_asc' : 'sorting'))}}">
                                                    {{
														link_to_route(
															"$modelName.index",
															trans("Customer"),
                                                ...
                                                <th
                                                    class="{{(($sortBy == 'nanny' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'nanny' && $order == 'asc') ? 'sorting_asc' : 'sorting'))}}">
                                                    {{
														link_to_route(
															"$modelName.index",
															trans("Nannay"),
                                                ...
                                                <th
                                                    class="{{(($sortBy == 'booking_date' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'booking_date' && $order == 'asc') ? 'sorting_asc' : 'sorting'))}}">
                                                    {{
														link_to_route(
															"$modelName.index",
															trans("Booking Date"),
                                                ...
                                                <th
                                                    class="{{(($sortBy == 'start_date' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'start_date' && $order == 'asc') ? 'sorting_asc' : 'sorting'))}}">
                                                    {{
														link_to_route(
															"$modelName.index",
															trans("Start Date"),
                                                ...
                                                <th
                                                    class="{{(($sortBy == 'end_date' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'end_date' && $order == 'asc') ? 'sorting_asc' : 'sorting'))}}">
                                                    {{
														link_to_route(
															"$modelName.index",
															trans("End Date"),
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="text-dark-75 mb-1 font-size-lg">
                                                        {{(!empty($result->booking_date) && $result->booking_date != "0000-00-00") ? date(Config::get("Reading.date_format"),strtotime($result->booking_date)) : ''}}
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="text-dark-75 mb-1 font-size-lg">
                                                       {{ !empty($result->start_date) ? date('d-m-Y',strtotime($result->start_date)):'' }}
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="text-dark-75 mb-1 font-size-lg">
                                                       {{ !empty($result->end_date) ? date('d-m-Y',strtotime($result->end_date)):'' }}
