	...
	<div class="d-flex flex-column-fluid">
		...
		<div class=" container ">
			...
			<div class="row">
						...
						<div class="accordion accordion-solid accordion-toggle-plus" id="accordionExample6">
							...
							<div>
								<div class="row mb-6">
									...
									<div class="col-lg-4 mb-lg-5 mb-6">
										<label>Email</label>
										{{ Form::text('email',((isset($searchVariable['email'])) ? $searchVariable['email'] : ''), ['class' => ' form-control','placeholder'=>'Email','id'=>'email']) }}
									</div>
				...
				<th
					class="{{(($sortBy == 'payout_date' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'payout_date' && $order == 'asc') ? 'sorting_asc' : 'sorting'))}}">
					{{
						link_to_route(
						"$modelName.index",
						trans("Payout Date"),
		...
		<tbody>
			...
			<tr>
				...
				<td>
					<div class="text-dark-75 mb-1 font-size-lg">
						{{ !empty($result->amount)?'$'.$result->amount:'' }}
					</div>
				</td>
				<td>
					<div class="text-dark-75 mb-1 font-size-lg">
						{{ !empty($result->payout_date)?date(config::get("Reading.date_format"),strtotime($result->payout_date)):'' }}
					</div>
				</td>
				<td>
					<div class="text-dark-75 mb-1 font-size-lg">
						{{ !empty($result->status == 1)? 'Complete':'Pending' }}
					</div>
				</td>
