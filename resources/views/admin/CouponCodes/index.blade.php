                                    ...
                                    <div>
                                        <div class="row mb-6">
                                            <div class="col-lg-4 mb-lg-5 mb-6">
                                                <label>Status</label>
                                                {{ Form::select('is_active',array(''=>trans('All'),1=>trans('Active'),0=>trans('Deactive')),((isset($searchVariable['is_active'])) ? $searchVariable['is_active'] : ''), ['class' => 'form-control select2init']) }}
                                            </div>
                                            <div class="col-lg-4 mb-lg-5 mb-6">
                                                <label>Coupon Code</label>
                                                {{ Form::text('coupon_code',((isset($searchVariable['coupon_code'])) ? $searchVariable['coupon_code'] : ''), ['class' => ' form-control','placeholder'=>'Coupon Code']) }}
                                            </div>
                                            <div class="col-lg-4 mb-lg-5 mb-6">
                                                <label>Coupon Type</label>
                                                {{ Form::select('coupon_type',array(''=>trans('All'),'fixed_amount'=>trans('Fixed Amount'),'percentage'=>trans('Percentage')),((isset($searchVariable['coupon_type'])) ? $searchVariable['coupon_type'] : ''), ['class' => 'form-control']) }}
                                            </div>
                                    ...
                                    <table
                                        ...
                                        <thead>
                                            <tr class="text-uppercase">
                                                <th
                                                    class="{{(($sortBy == 'coupon_code' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'coupon_code' && $order == 'asc') ? 'sorting_asc' : 'sorting'))}}">
                                                    {{
														link_to_route(
															"$modelName.index",
															trans("Coupon Code"),
                                                ...
                                                <th
                                                    class="{{(($sortBy == 'coupon_type' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'coupon_type' && $order == 'asc') ? 'sorting_asc' : 'sorting'))}}">
                                                    {{
														link_to_route(
															"$modelName.index",
															trans("Coupon Type"),
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="text-dark-75 mb-1 font-size-lg">
                                                    @if($result->coupon_type == 'fixed_amount')
                                                        <span class="label-primary" >	{{ strtoupper($result->coupon_type) }}</span>
                                                    @else
                                                        <span class="label-info" >{{ strtoupper($result->coupon_type) }}</span>
                                                    @endif
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="text-dark-75 mb-1 font-size-lg">
                                                        {{ $result->amount }}
                                                        @if($result->coupon_type == 'percentage') % @endif
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="text-dark-75 mb-1 font-size-lg">
                                                        {{(!empty($result->start_date) && $result->start_date != "0000-00-00") ? date(Config::get("Reading.date_format"),strtotime($result->start_date)) : ''}}
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="text-dark-75 mb-1 font-size-lg">
                                                        {{(!empty($result->end_date) && $result->end_date != "0000-00-00") ? date(Config::get("Reading.date_format"),strtotime($result->end_date)) : ''}}
                                                    </div>
                                                </td>
                                                <td>
