...
<div class="content  d-flex flex-column flex-column-fluid" id="kt_content">
	...
	<div class="d-flex flex-column-fluid">
		...
		<div class=" container ">
			{{ Form::open(['method' => 'get','role' => 'form','url' => 'adminpnlx/news-letter','class' => 'kt-form kt-form--fit mb-0','autocomplete'=>"off"]) }}
			{{ Form::hidden('display') }}
			<div class="row">
				<div class="col-12">
									...
									<div>
											...
											<div class="row mt-8">
												<div class="col-lg-12">
													...
													<a href="{{URL::to('adminpnlx/news-letter')}}" class="btn btn-secondary btn-secondary--icon">
														<span>
								...
								<div class="table-responsive">
									<table
										...
										<tr class="text-uppercase">
												...
												<th class="{{(($sortBy == 'scheduled_time' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'scheduled_time' && $order == 'asc') ? 'sorting_asc' : 'sorting'))}}">
													{{
														link_to_route(
															'NewsLetter.listTemplate',
											...
											@if(!$results->isEmpty())
												@foreach($results as $record)
													<tr>
														...
														<td>
															<div class="text-dark-75 mb-1 font-size-lg">
																{{ date(Config::get("Reading.date_format"),strtotime($record->scheduled_time)) }}
															</div>
														</td>
														...
														<td class="text-right pr-2">																										
															<a href="{{URL::to('adminpnlx/news-letter/edit-template/'.$record->id)}}"
