...
<div class="content  d-flex flex-column flex-column-fluid" id="kt_content">
    ...
    <div class="d-flex flex-column-fluid">
        <!--begin::Container-->
        <div class=" container ">
        {{ Form::open(['role' => 'form','url' => 'adminpnlx/news-letter/send-newsletter-templates/'.$result->id,'class' => 'mws-form', 'files' => true,"autocomplete"=>"off"]) }}
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-xl-10">
                            <h3 class="mb-10 font-weight-bold text-dark">
								Send Newsletter Information</h3>
                            ...
                            <div class="row">           
								...
								<div class="col-xl-6">
                                    <!--begin::Input-->
                                    <div class="form-group">
                                        {!! HTML::decode( Form::label('scheduled_time', trans("Scheduled Date").'<span
                                            class="text-danger"> * </span>')) !!}

                                            <div class="input-group date" id="datepickerfrom" data-target-input="nearest">
                                            {{ Form::text('scheduled_time','', ['class' => 'form-control form-control-solid form-control-lg datetimepicker-input '.($errors->has('scheduled_time') ? 'is-invalid':''),'placeholder'=>'Scheduled Date','data-target'=>'#datepickerfrom','data-toggle'=>'datetimepicker','id'=>'scheduled_time']) }}
								...
								<div class="col-xl-6">
                                    <!--begin::Input-->
                                    <div class="form-group">
                                        {!! HTML::decode( Form::label('newsletter_subscriber_id', trans("Subscribers").'<span
                                            class="text-danger"> </span>')) !!}	 (Leave blank for select all)									
										{{ Form::select('newsletter_subscriber_id[]' ,$subscriberArray , null , ['class' => 'form-control form-control-solid form-control-lg chzn-select '.($errors->has('newsletter_subscriber_id') ? 'is-invalid':''),'data-placeholder'=>'Select Subscribers','multiple'=>'multiple']) }}
