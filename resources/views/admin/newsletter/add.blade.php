...
<div class="mws-panel grid_8">
	<div class="mws-panel-header">
		...
		<a href="{{URL::to('adminpnlx/email-manager')}}" class="btn btn-success btn-small align">{{ 'Back To Email Template' }} </a>
	</div>
		...
		{{ Form::open(['role' => 'form','url' => 'adminpnlx/email-manager/add-template','class' => 'mws-form']) }}
			...
			<div class="mws-button-row">
				<div class="input" >
					...
					<a href="{{URL::to('adminpnlx/email-manager/add-template')}}" class="btn primary"><i class=\"icon-refresh\"></i> Reset</a>
				</div>
			</div>
		{{ Form::close() }}
	</div>    	
