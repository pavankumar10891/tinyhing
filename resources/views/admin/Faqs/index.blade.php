					...
					<div class="card card-custom card-stretch card-shadowless">
						<div class="card-header">
							...
							<div class="card-toolbar">
								...
								<a href='{{route($modelName.'.add')}}'  class="btn btn-primary"> {{ trans("Add New ") }}{{ $sectionNameSingular }} </a>
							</div>
						</div>
						<div class="card-body">
									...
									<div>
											<div class="row mb-6">
												<div class="col-lg-3 mb-lg-5 mb-6">
													<label>Status</label>
													{{ Form::select('is_active',array(''=>trans('All'),1=>trans('Active'),0=>trans('Inactive')),((isset($searchVariable['is_active'])) ? $searchVariable['is_active'] : ''), ['class' => 'form-control select2init']) }}
												</div>
												<div class="col-lg-3 mb-lg-5 mb-6">
													...
													<tr>
														<td style="width:400px;">
															<div class="text-dark-75 mb-1 font-size-lg">
																{!! strip_tags(Str::limit($result->question, 300)) !!}
															</div>
														</td>
														<td style="width:400px;">
															<div class="text-dark-75 mb-1 font-size-lg">
																{!! strip_tags(Str::limit($result->answer, 300)) !!}
															</div>
														</td>
														<td>
															<div class="text-dark-75 mb-1 font-size-lg">
														...
														<td class="text-right pr-2">
															@if($result->is_active == 1)
																<a  title="Click To Deactivate" href='{{route("$modelName.status",array($result->id,0))}}' class="btn btn-icon btn-light btn-hover-danger btn-sm status_any_item" data-toggle="tooltip" data-placement="top" data-container="body" data-boundary="window" data-original-title="Click To Deactivate">
															...
															@else
																<a title="Click To Activate" href='{{route("$modelName.status",array($result->id,1))}}' class="btn btn-icon btn-light btn-hover-success btn-sm status_any_item" data-toggle="tooltip" data-placement="top" data-container="body" data-boundary="window" data-original-title="Click To Deactivate">
