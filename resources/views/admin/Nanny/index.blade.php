                                    ...
                                    <div>
                                        <div class="row mb-6">
                                            ...
                                            <div class="col-lg-4 mb-lg-5 mb-6">
                                                ...
                                                {{ Form::text('phone',((isset($searchVariable['phone_number'])) ? $searchVariable['phone_number'] : ''), ['class' => ' form-control','placeholder'=>'Phone Number']) }}
                                            </div>
                                            <div class="col-lg-4 mb-lg-5 mb-6">
                                    ...
                                    <table
                                        ...
                                        <thead>
                                            <tr class="text-uppercase">
                                                <th
                                                    class="{{(($sortBy == 'nanny_type' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'nanny_type' && $order == 'asc') ? 'sorting_asc' : 'sorting'))}}">
                                                    {{
                                                        link_to_route(
                                                            "$modelName.index",
                                                            trans("Type"),
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="text-dark-75 mb-1 font-size-lg">
                                                         @if($result->nanny_type == 1)
                                                         Nanny
                                                         @elseif($result->nanny_type == 2)
                                                         Babbysitter
                                                         @elseif($result->nanny_type == 3)
                                                ...
                                                <td class="text-right pr-2">
                                                    ...
                                                    <a title="Click To Approve"
                                                        href='{{route("$modelName.senduserverification",array($result->id,1))}}'
                                                    ...
                                                    <a title="Click to Reject"
                                                        href='{{route("$modelName.senduserverification",array($result->id,2))}}'
                                                    ...
                                                    <a title="Click To Deactive"
                                                        href='{{route("$modelName.status",array($result->id,0))}}'
                                                        class="btn btn-icon btn-light btn-hover-success btn-sm status_any_item"
                                                        data-toggle="tooltip" data-placement="top" data-container="body"
                                                        data-boundary="window" data-original-title="Click To Approve">
                                                        <span class="svg-icon svg-icon-md svg-icon-danger">
                                                  ...
                                                  <a title="Click to Active"
                                                        href='{{route("$modelName.status",array($result->id,1))}}'
                                                        class="btn btn-icon btn-light btn-hover-danger btn-sm status_any_item"
                                                        data-toggle="tooltip" data-placement="top" data-container="body"
                                                        data-boundary="window" data-original-title="Activate">
                                                        <span class="svg-icon svg-icon-md svg-icon-success">
                                                    ...
                                                    <div class="dropdown dropdown-inline">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                                                            <ul class="nav nav-hoverable flex-column">
                                                                <li class="nav-item">
                                                                    <a class="nav-link"
                                                                        href='{{route("$modelName.verification","$result->id")}}'>
