									...
									<table
										...
										<thead>
                                            <tr class="text-uppercase">
                                                ...
                                                <th class="{{(($sortBy == 'no_of_month' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'no_of_month' && $order == 'asc') ? 'sorting_asc' : 'sorting'))}}">
                                                    {{
                                                        link_to_route(
                                                            "$modelName.index",
                                                ...
                                                <th class="{{(($sortBy == 'order_type' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'order_type' && $order == 'asc') ? 'sorting_asc' : 'sorting'))}}">
                                                    {{
                                                        link_to_route(
                                                            "$modelName.index",
                                                            trans("Order"),
