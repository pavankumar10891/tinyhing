                        ...
                        <div class="col-xl-10">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-6">
                                    ...
                                    <div class="form-group">
                                        {!! HTML::decode( Form::label('price', trans("Price").'<span class="text-danger">
                                            * </span>')) !!}
                                        {{ Form::text('price','', ['class' => 'form-control form-control-solid form-control-lg '.($errors->has('price') ? 'is-invalid':'')]) }}
                                ...
                                <div class="col-xl-6">
                                    <!--begin::Input-->
                                    <div class="form-group">
                                        {!! HTML::decode( Form::label('month', trans("Number Of Month").'<span class="text-danger">
                                            * </span>')) !!}
                                        {{ Form::text('month','', ['class' => 'form-control form-control-solid form-control-lg '.($errors->has('month') ? 'is-invalid':'')]) }}
                                ...
                                <div class="col-xl-6">
                                    ...
                                    <div class="form-group">
                                        {!! HTML::decode( Form::label('order_type', trans("Order").'<span class="text-danger">
                                             *</span>')) !!}
                                        {{ Form::text('order_type','', ['class' => 'form-control form-control-solid form-control-lg '.($errors->has('order_type') ? 'is-invalid':'')]) }}
