					...
					<div class="tab-content px-10">
						...
						<div class="tab-pane active" id="kt_apps_contacts_view_tab_1" role="tabpanel">
							...
							<div class="form-group row my-2">
								...
								<div class="col-8">
									<span class="form-control-plaintext font-weight-bolder">{{ isset($model->price) ? number_format($model->price, 2) :'' }}</span>
								</div>
							</div>
							...
							<div class="form-group row my-2">
								...
								<div class="col-8">
									<span class="form-control-plaintext font-weight-bolder">{{ isset($model->no_of_month) ? $model->no_of_month :'' }}</span>
								</div>
							</div>
							...
							<div class="form-group row my-2">
								...
								<div class="col-8">
									<span class="form-control-plaintext font-weight-bolder">{{ isset($model->order_type) ? $model->order_type :'' }}</span>
								</div>
							</div>
