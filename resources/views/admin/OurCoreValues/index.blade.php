                                    ...
                                    <table
                                        ...
                                        <thead>
                                            <tr class="text-uppercase">
                                                ...
                                                <th
                                                    class="{{(($sortBy == 'description' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'description' && $order == 'asc') ? 'sorting_asc' : 'sorting'))}}">
                                                    {{
														link_to_route(
															"$modelName.index",
															trans("Description"),
                                                ...
                                                <th
                                                    class="{{(($sortBy == 'order_number' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'order_number' && $order == 'asc') ? 'sorting_asc' : 'sorting'))}}">
                                                    {{
														link_to_route(
															"$modelName.index",
															trans("Order"),
                                                ...
                                                <td>
                                                    <div class="text-dark-75 mb-1 font-size-lg">
                                                        ...
                                                        <a class="fancybox-buttons" data-fancybox-group="button"
                                                            href="{{OURCOREVALUES_IMAGE_URL.$result->image}}">
                                                            <img class="" src="{{OURCOREVALUES_IMAGE_URL.$result->image}}"
