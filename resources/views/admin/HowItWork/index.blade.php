					...
					<div class="card card-custom card-stretch card-shadowless">
						...
						<div class="card-body">
								...
								<div id="collapseOne6" class="collapse <?php echo !empty($searchVariable) ? 'show' : ''; ?>" data-parent="#accordionExample6">
									<div>
											<div class="row mb-6">
												...
												<!-- <div class="col-lg-4 mb-lg-5 mb-6">
													<label>Service Radius From</label>
													{{ Form::text('service_radius',((isset($searchVariable['service_radius'])) ? $searchVariable['service_radius'] : ''), ['class' => ' form-control','placeholder'=>'Service Radius From']) }}
												</div>
												<div class="col-lg-4 mb-lg-5 mb-6">
													<label>Service Radius To</label>
													{{ Form::text('service_radius',((isset($searchVariable['service_radius'])) ? $searchVariable['service_radius'] : ''), ['class' => ' form-control','placeholder'=>'Service Radius To']) }}
												</div> -->
							...
							<div class="dataTables_wrapper ">
								<div class="table-responsive">
									<table
										...
										<th>
												...
												<th class="{{(($sortBy == 'work_order' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'work_order' && $order == 'asc') ? 'sorting_asc' : 'sorting'))}}">
													{{
														link_to_route(
															"$modelName.index",
															trans("Order"),
															array(
															'sortBy' => 'work_order',
															'order' => ($sortBy == 'work_order' && $order == 'desc') ? 'asc' : 'desc',
															$query_string
															)
														)
													}}
											...
											@if(!$results->isEmpty())
												@foreach($results as $result)
													...
													<td>
                                                        ...
                                                        @if($result->image != "")
																	<br />
																	<a class="fancybox-buttons" data-fancybox-group="button" href="{{HOWITWORK_IMAGE_URL.$result->image}}">
																		<img class="" src="{{HOWITWORK_IMAGE_URL.$result->image}}" width="50px" height="50px">
																	</a>
																@endif
															</div>
														</td>
								...
								{{-- @include('pagination.defaultresults' => $results]) --}}
							</div>
						</div>
					</div>
				</div>
