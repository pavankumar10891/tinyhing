        ...
        <div class="login login-4 wizard d-flex flex-column flex-lg-row flex-column-fluid">
            ...
            <div
                ...
                <div class="login-content d-flex flex-column pt-lg-0 pt-12">
                    ...
                    <div class="login-form">
                        <!--begin::Form-->
						{{ Form::open(['role' => 'form','url' => 'adminpnlx/save_password',"class"=>"form","id"=>"kt_login_singin_form"]) }}   
						 {{ Form::hidden('validate_string',$validate_string) }}
                            ...
                            <div class="form-group">
								...
								{{ Form::password('new_password',  ['class' => "form-control form-control-solid h-auto py-7 px-6 rounded-lg border-0 ".($errors->has('new_password') ? 'is-invalid':'')]) }}	
								
                                <div class="invalid-feedback"><?php echo $errors->first('new_password'); ?></div>
                            </div>
							<!--end::Form group-->
							 ...
							 <div class="form-group">
                                ...
                                <!-- toggle class "is-invalid" on input for error -->
								{{ Form::password('new_password_confirmation',  ['class' => "form-control form-control-solid h-auto py-7 px-6 rounded-lg border-0 ".($errors->has('new_password_confirmation') ? 'is-invalid':'')]) }}	
								
                                <div class="invalid-feedback"><?php echo $errors->first('new_password_confirmation'); ?></div>
                            </div>
                            <!--end::Form group-->
                            ...
                            <div class="pb-lg-0 pb-5">
                                <a href="javascript:void(0);" id="kt_login_submit"
                                    class="btn btn-primary font-weight-bolder font-size-h6 px-8 py-4 my-3 mr-3">Submit</a>
								
								<a href="{{URL('/adminpnlx/login')}}"
                                    class="btn btn-primary font-weight-bolder font-size-h6 px-8 py-4 my-3 mr-3">Back To Login</a>
                            </div>
                            <!--end::Action-->
                        {{ Form::close() }}
                        <!--end::Form-->
            ...
            <div class="login-aside order-1 order-lg-2 bgi-no-repeat bgi-position-x-right">
                <div class="login-conteiner bgi-no-repeat bgi-position-x-right bgi-position-y-bottom"
                    style="background-image: url({{WEBSITE_IMG_URL}}login-visual-4.svg);">
                    <!--begin::Aside title-->
                    <h3
