            ...
            <div
                ...
                <div class="login-content d-flex flex-column pt-lg-0 pt-12">
                    ...
                    <a href="{{WEBSITE_URL}}" class="login-logo pb-xl-20 pb-15">
                        <img src="{{WEBSITE_IMG_URL}}tinyhugs-logo.png" class="max-h-70px" alt="" />
                    </a>
                    <!--end::Logo-->
                    ...
                    <div class="login-form">
                        <!--begin::Form-->
						{{ Form::open(['role' => 'form','url' => 'adminpnlx/login',"class"=>"form","id"=>"kt_login_singin_form"]) }}   
                            <!--begin::Title-->
                            ...
                            <div class="form-group">
                                <div class="d-flex justify-content-between mt-n5">
                                    ...
                                    <a href="{{ URL::to('adminpnlx/forget_password')}}"
