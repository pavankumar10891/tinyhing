                            ...
                            <div class="row">
                                <div class="col-xl-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        {{ Form::text('title',(!empty($model->title)?$model->title:''), ['class' => 'form-control form-control-solid form-control-lg '.($errors->has('title') ? 'is-invalid':'')]) }}
                                ...
                                <div class="col-xl-6">
                                    ...
                                    <div class="form-group">
                                        {!! HTML::decode( Form::label('description', trans("Description").'<span
                                            class="text-danger"> * </span>')) !!}
                                        {{ Form::textarea('description',(!empty($model->description)?$model->description:''), ['class' => 'form-control form-control-solid form-control-lg '.($errors->has('description') ? 'is-invalid':''),'id' => 'description']) }}
                                ...
                                <div class="col-xl-6">
                                    <!--begin::Input-->
                                    <div class="form-group">
                                        {!! HTML::decode( Form::label('order', trans("Order").'<span
                                            class="text-danger"> * </span>')) !!}
                                        {{ Form::text('order',(!empty($model->order_number)?$model->order_number:''), ['class' => 'form-control form-control-solid form-control-lg '.($errors->has('order') ? 'is-invalid':'')]) }}
                                        <div class="invalid-feedback"><?php echo $errors->first('order'); ?></div>
                                    </div>
                                    <!--end::Input-->
                                </div>
