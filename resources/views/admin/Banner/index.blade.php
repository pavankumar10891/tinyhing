								...
								<div class="table-responsive">
									<table
										...
										<th>
												...
												<th class="{{(($sortBy == 'order_number' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'order_number' && $order == 'asc') ? 'sorting_asc' : 'sorting'))}}">
													{{
														link_to_route(
															"$modelName.index",
															trans("Order"),
													...
													<td>
                                                        ...
                                                        @if($result->image != "")
																	...
																	<a class="fancybox-buttons" data-fancybox-group="button" href="{{$result->image}}">
																		<img class="" src="{{$result->image}}" width="50px" height="50px">
																	</a>
																@endif
															</div>
														</td>
